...
var P2 = function() {
  var e = function(H1, a, o, T) {
    ...
    performAction: function(a, o, T, n, X, t, i2) {
      var s = t.length - 1;
      switch (X) {
        case 5:
          ...
          break;
        case 6:
          n.parseDirective(t[s], "type_directive");
          break;
        case 7:
          t[s] = t[s].trim().replace(/'/g, '"'), n.parseDirective(t[s], "arg_directive");
          break;
        case 8:
    ...
    parse: function(a) {
      var o = this, T = [0], n = [], X = [null], t = [], i2 = this.table, s = "", l1 = 0, X2 = 0, xe = 2, q2 = 1, Re = t.slice.call(arguments, 1), e1 = Object.create(this.lexer), q1 = { yy: {} };
      for (var L2 in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, L2) && (q1.yy[L2] = this.yy[L2]);
      ...
      function Ie() {
        var j1;
        return j1 = n.pop() || e1.lex() || q2, typeof j1 != "number" && (j1 instanceof Array && (n = j1, j1 = n.pop()), j1 = o.symbols_[j1] || j1), j1;
      }
      for (var a1, Z1, h1, N2, e2 = {}, g2, K1, Z2, F2; ; ) {
        if (Z1 = T[T.length - 1], this.defaultActions[Z1] ? h1 = this.defaultActions[Z1] : ((a1 === null || typeof a1 > "u") && (a1 = Ie()), h1 = i2[Z1] && i2[Z1][a1]), typeof h1 > "u" || !h1.length || !h1[0]) {
          ...
          F2 = [];
          for (g2 in i2[Z1])
            this.terminals_[g2] && g2 > xe && F2.push("'" + this.terminals_[g2] + "'");
          e1.showPosition ? O2 = "Parse error on line " + (l1 + 1) + `:
` + e1.showPosition() + `
Expecting ` + F2.join(", ") + ", got '" + (this.terminals_[a1] || a1) + "'" : O2 = "Parse error on line " + (l1 + 1) + ": Unexpected " + (a1 == q2 ? "end of input" : "'" + (this.terminals_[a1] || a1) + "'"), this.parseError(O2, {
            text: e1.match,
        ...
        switch (h1[0]) {
          case 1:
            T.push(a1), X.push(e1.yytext), t.push(e1.yylloc), T.push(h1[1]), a1 = null, X2 = e1.yyleng, s = e1.yytext, l1 = e1.yylineno, I2 = e1.yylloc;
            break;
          case 2:
            ...
            ]), N2 = this.performAction.apply(e2, [
              s,
              X2,
              l1,
              q1.yy,
    ...
    var H1 = {
      ...
      unput: function(a) {
        ...
        return this.yylloc = {
          ...
          last_column: T ? (T.length === n.length ? this.yylloc.first_column : 0) + n[n.length - T.length].length - T[0].length : this.yylloc.first_column - o
...
` + o + "^";
      ...
      test_match: function(a, o) {
        ...
        }, this.options.ranges && (X.yylloc.range = this.yylloc.range.slice(0))), n = a[0].match(/(?:\r\n?|\n).*/g), n && (this.yylineno += n.length), this.yylloc = {
      ...
      next: function() {
        ...
        for (var X = this._currentRules(), t = 0; t < X.length; t++)
          if (T = this._input.match(this.rules[X[t]]), T && (!o || T[0].length > o[0].length)) {
            if (o = T, n = t, this.options.backtrack_lexer) {
        ...
        return o ? (a = this.test_match(o, X[n]), a !== !1 ? a : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: function(o, T, n, X) {
        switch (n) {
          case 0:
  ...
  return R2.prototype = x2, x2.Parser = R2, new R2();
}();
P2.parser = P2;
const et = P2, Ye = "flowchart-";
let J2 = 0, K2 = U2(), z = {}, J1 = [], t2 = {}, W1 = [], _2 = {}, B2 = {}, C2 = 0, w2 = !0, A1, T2, y2 = [];
const S2 = (e) => We.sanitizeText(e, K2), $2 = function(e, u, r) {
  Ke.parseDirective(this, e, u, r);
}, c2 = function(e) {
  ...
  H !== void 0 && H.trim().length !== 0 && (z[H] === void 0 && (z[H] = {
    ...
    styles: [],
    classes: []
  }), J2++, u !== void 0 ? (K2 = U2(), u1 = S2(u.text.trim()), z[H].labelType = u.type, u1[0] === '"' && u1[u1.length - 1] === '"' && (u1 = u1.substring(1, u1.length - 1)), z[H].text = u1) : z[H].text === void 0 && (z[H].text = e), r !== void 0 && (z[H].type = r), i != null && i.forEach(function(s1) {
    z[H].styles.push(s1);
  ...
  M2.info("abc78 Got edge...", _);
  const B = r.text;
  B !== void 0 && (_.text = S2(B.text.trim()), _.text[0] === '"' && _.text[_.text.length - 1] === '"' && (_.text = _.text.substring(1, _.text.length - 1)), _.labelType = B.type), r !== void 0 && (_.type = r.type, _.stroke = r.stroke, _.length = r.length), J1.push(_);
}, se = function(e, u, r) {
  M2.info("addLink (abc78)", e, u, r);
  let i, c;
  ...
  e.forEach(function(r) {
    r === "default" ? J1.defaultInterpolate = u : J1[r].interpolate = u;
  });
}, re = function(e, u) {
  e.forEach(function(r) {
    r === "default" ? J1.defaultStyle = u : (G2.isSubstringInArray("fill", u) === -1 && u.push("fill:none"), J1[r].style = u);
  });
}, ie = function(e, u) {
  e.split(",").forEach(function(r) {
    t2[r] === void 0 && (t2[r] = { id: r, styles: [], textStyles: [] }), u != null && u.forEach(function(i) {
      if (i.match("color")) {
        const c = i.replace("fill", "bgFill").replace("color", "fill");
        t2[r].textStyles.push(c);
      }
      t2[r].styles.push(i);
    });
  });
}, ne = function(e) {
  A1 = e, A1.match(/.*</) && (A1 = "RL"), A1.match(/.*\^/) && (A1 = "BT"), A1.match(/.*>/) && (A1 = "LR"), A1.match(/.*v/) && (A1 = "TB"), A1 === "TD" && (A1 = "TB");
}, m2 = function(e, u) {
  e.split(",").forEach(function(r) {
    let i = r;
  ...
  e.split(",").forEach(function(r) {
    u !== void 0 && (B2[T2 === "gen-1" ? c2(r) : r] = S2(u));
  });
}, He = function(e, u, r) {
  let i = c2(e);
  if (U2().securityLevel !== "loose" || u === void 0)
    return;
  let c = [];
  if (typeof r == "string") {
    c = r.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
  ...
  c.length === 0 && c.push(e), z[e] !== void 0 && (z[e].haveCallback = !0, y2.push(function() {
  ...
  e.split(",").forEach(function(i) {
    z[i] !== void 0 && (z[i].link = G2.formatUrl(u, K2), z[i].linkTarget = r);
  }), m2(e, "clickable");
}, ce = function(e) {
  if (B2.hasOwnProperty(e))
    return B2[e];
}, oe = function(e, u, r) {
  e.split(",").forEach(function(i) {
    He(i, u, r);
  ...
  let u = n2(".mermaidTooltip");
  (u._groups || u)[0][0] === null && (u = n2("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), n2(e).select("svg").selectAll("g.node").on("mouseover", function() {
    const c = n2(this);
    ...
    u.transition().duration(500).style("opacity", 0), n2(this).classed("hover", !1);
  });
};
y2.push(de);
const Ee = function(e = "gen-1") {
  z = {}, t2 = {}, J1 = [], y2 = [de], W1 = [], _2 = {}, C2 = 0, B2 = {}, w2 = !0, T2 = e, je();
}, be = (e) => {
  T2 = e || "gen-2";
}, ke = function() {
  return "fill:#ffa;stroke: #f66; stroke-width: 3px; stroke-dasharray: 5, 5;fill:#ffa;stroke: #666;";
}, De = function(e, u, r) {
  let i = e.text.trim(), c = r.text;
  e === r && r.text.match(/\s/) && (i = void 0);
  function _(f1) {
  ...
  if (B = u1, T2 === "gen-1")
    for (let f1 = 0; f1 < B.length; f1++)
      B[f1] = c2(B[f1]);
  i = i || "subGraph" + C2, c = c || "", c = S2(c), C2 = C2 + 1;
  const s1 = {
    id: i,
    nodes: B,
    title: c.trim(),
  ...
  return M2.info("Adding", s1.id, s1.nodes, s1.dir), s1.nodes = me(s1, W1).nodes, W1.push(s1), _2[i] = s1, i;
}, Qe = function(e) {
  for (const [u, r] of W1.entries())
    if (r.id === e)
      return u;
  return -1;
};
...
const ge = [], Fe = function(e, u) {
  ...
  let u = e.trim(), r = "arrow_open";
  switch (u[0]) {
    case "<":
      r = "arrow_point", u = u.slice(1);
      break;
    case "x":
      r = "arrow_cross", u = u.slice(1);
      break;
    case "o":
      r = "arrow_circle", u = u.slice(1);
      break;
  }
  let i = "normal";
  return u.includes("=") && (i = "thick"), u.includes(".") && (i = "dotted"), { type: r, stroke: i };
}, qe = (e, u) => {
  const r = u.length;
  let i = 0;
  for (let c = 0; c < r; ++c)
  ...
  const u = e.trim();
  let r = u.slice(0, -1), i = "arrow_open";
  switch (u.slice(-1)) {
    case "x":
      i = "arrow_cross", u[0] === "x" && (i = "double_" + i, r = r.slice(1));
      break;
    case ">":
      i = "arrow_point", u[0] === "<" && (i = "double_" + i, r = r.slice(1));
      break;
    case "o":
      i = "arrow_circle", u[0] === "o" && (i = "double_" + i, r = r.slice(1));
      break;
  }
  let c = "normal", _ = r.length - 1;
  r[0] === "=" && (c = "thick"), r[0] === "~" && (c = "invisible");
  let B = qe(".", r);
  ...
  if (u) {
    ...
    return i.type === "double_arrow" && (i.type = "double_arrow_point"), i.length = r.length, i;
  }
  return r;
}, Se = (e, u) => {
  let r = !1;
  return e.forEach((i) => {
    i.nodes.indexOf(u) >= 0 && (r = !0);
  }), r;
}, me = (e, u) => {
  const r = [];
  return e.nodes.forEach((i, c) => {
    Se(u, i) || r.push(e.nodes[c]);
  }), { nodes: r };
}, ve = {
  firstGraph: Te
}, Je = {
