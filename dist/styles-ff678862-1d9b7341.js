import { i as V, G as M } from "./layout-ae80f9eb.js";
import { S as I, v as R, x as F, _ as U, C as H, y as W, o as A, l as u, p as X, c as C, j as G, q as $, r as E, h as _, z as J, t as K, A as Q } from "./index-20be57f3.js";
import { f as Y } from "./flowDb-8f9fc471-50ce1924.js";
import { r as Z } from "./index-4c4adb72-8b204854.js";
function j(e) {
...
const z = {}, ae = function(e) {
  ...
  e.forEach(function(n) {
    ...
    const g = "LS-" + n.start, h = "LE-" + n.end, t = { style: "", labelStyle: "" };
    ...
    switch (n.stroke) {
      case "normal":
        s = "fill:none;", d !== void 0 && (s = d), w !== void 0 && (b = w), t.thickness = "normal", t.pattern = "solid";
        break;
      case "dotted":
...
`), n.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + g + " " + h, l.setEdge(n.start, n.end, t, a);
  });
}, oe = function(e, l) {
  ...
  i === void 0 && (i = "TD");
  const { securityLevel: d, flowchart: w } = C(), n = w.nodeSpacing || 50, p = w.rankSpacing || 50;
  let r;
  d === "sandbox" && (r = _("#i" + l));
  ...
  for (let f = b.length - 1; f >= 0; f--)
    s = b[f], u.info("Subgraph - ", s), a.db.addVertex(
      s.id,
  ...
  for (k = b.length - 1; k >= 0; k--) {
    s = b[k], j("cluster").append("text");
    for (let f = 0; f < s.nodes.length; f++)
      u.info("Setting up subgraphs", s.nodes[f], s.id), t.setParent(s.nodes[f], s.id);
  }
  q(o, t, l, g, h, a), P(m, t);
  const T = g.select(`[id="${l}"]`), v = g.select("#" + l + " g");
  if (await Z(v, t, ["point", "circle", "cross"], "flowchart", l), J.insertTitle(T, "flowchartTitleText", w.titleTopMargin, a.db.getDiagramTitle()), K(t, T, w.diagramPadding, w.useMaxWidth), a.db.indexNodes("subGraph" + k), !w.htmlLabels) {
    const f = h.querySelectorAll('[id="' + l + '"] .edgeLabel .label');
    for (const x of f) {
