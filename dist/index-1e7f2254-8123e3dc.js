import { b as k, a as v, m as D, G, l as j } from "./layout-d98ae1de.js";
import { i as A, u as M, s as _, a as H, b as V, p as B, c as U, d as W, e as Y, f as q, g as O, h as X } from "./edges-66ea8538-ba4f14a9.js";
import { l as i, p as N, c as E, h as L } from "./index-14ad5708.js";
import { c as z } from "./createText-a49d2d2a-15fbd547.js";
var K = 4;
function Q(e) {
  return k(e, K);
}
function y(e) {
  ...
  return v(e.graph()) || (t.value = Q(e.graph())), t;
}
function Z(e) {
  return D(e.nodes(), function(t) {
    var n = e.node(t), r = e.parent(t), s = { v: t };
    return v(n) || (s.value = n), v(r) || (s.parent = r), s;
  });
}
function I(e) {
...
const tt = () => {
...
}, b = (e) => !f[e] || !f[e].externalConnections ? e : f[e] ? f[e].id : e, nt = (e, t) => {
  if (!e || t > 10) {
  ...
  e.nodes().forEach(function(n) {
    e.children(n).length > 0 && (i.warn(
      ...
      m(n, e)
    ), x[n] = p(n, e), f[n] = { id: m(n, e), clusterData: e.node(n) });
  }), e.nodes().forEach(function(n) {
    ...
    if (i.warn(
      ...
      i.warn("Fixing and trixing link to self - removing XXX", n.v, n.w, n.name), i.warn("Fixing and trixing - removing XXX", n.v, n.w, n.name), s = b(n.v), a = b(n.w), e.removeEdge(n.v, n.w, n.name);
      const h = n.w + "---" + n.v;
      e.setNode(h, {
        domId: h,
        id: h,
      ...
      (f[n.v] || f[n.w]) && (i.warn("Fixing and trixing - removing XXX", n.v, n.w, n.name), s = b(n.v), a = b(n.w), e.removeEdge(n.v, n.w, n.name), s !== n.v && (r.fromCluster = n.v), a !== n.w && (r.toCluster = n.w), i.warn("Fix Replacing with XXX", s, a, n.name), e.setEdge(s, a, r, n.name));
...
const lt = (e, t) => {
  ...
  await Promise.all(
    t.nodes().map(async function(c) {
      ...
      if (i.info("(Insert) Node XXX" + c + ": " + JSON.stringify(t.node(c))), o && o.clusterNode) {
        ...
        const u = await $(w, o.graph, n, t.node(c)), C = u.elem;
        M(o, C), o.diff = u.diff || 0, i.info("Node bounds (abc123)", c, o, o.width, o.x, o.y), _(C, o), i.warn("Recursive render complete ", C, o);
      } else
        t.children(c).length > 0 ? (i.info("Cluster - the non recursive path XXX", c, o.id, o, t), i.info(m(o.id, t)), f[o.id] = { id: m(o.id, t), node: o }) : (i.info("Node - the non recursive path", c, o.id, o), await H(w, t.node(c), s));
    })
  ...
  }), i.info("#############################################"), i.info("###                Layout                 ###"), i.info("#############################################"), i.info(t), j(t), i.info("Graph after layout:", y(t));
  let g = 0;
  ...
  A(e, n, r, s), Y(), q(), ft(), tt(), i.warn("Graph at first:", y(t)), nt(t), i.warn("Graph after:", y(t)), await $(e, t, r);
};
export {
  gt as r
};
