import { ax as bt, ay as vt, B as kt, c as wt, l as I, h as U, t as St, az as Et, aA as Tt, aB as It } from "./index-696d0216.js";
import { a as it } from "./arc-4b269d58.js";
import "vue";
import "./path-428ebac9.js";
var Y = function() {
  var n = function(b, r, a, h) {
    for (a = a || {}, h = b.length; h--; a[b[h]] = r)
      ;
    return a;
  }, t = [1, 2], e = [1, 5], s = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], i = [1, 15], o = [1, 16], l = [1, 17], g = [1, 18], d = [1, 19], y = [1, 23], x = [1, 24], w = [1, 27], v = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], _ = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(r, a, h, u, f, c, T) {
      var m = c.length - 1;
      switch (f) {
        case 1:
          return c[m - 1];
        ...
        case 8:
          ...
          break;
        case 11:
          u.getCommonDb().setDiagramTitle(c[m].substr(6)), this.$ = c[m].substr(6);
          break;
        case 12:
          this.$ = c[m].trim(), u.getCommonDb().setAccTitle(this.$);
          break;
        case 13:
        case 14:
          this.$ = c[m].trim(), u.getCommonDb().setAccDescription(this.$);
          break;
        case 15:
          u.addSection(c[m].substr(8)), this.$ = c[m].substr(8);
          break;
        case 19:
          u.addTask(c[m], 0, ""), this.$ = c[m];
          break;
        case 20:
          u.addEvent(c[m].substr(2)), this.$ = c[m];
          break;
        case 21:
          u.parseDirective("%%{", "open_directive");
          break;
        case 22:
          u.parseDirective(c[m], "type_directive");
          break;
        case 23:
          c[m] = c[m].trim().replace(/'/g, '"'), u.parseDirective(c[m], "arg_directive");
          break;
        case 24:
    ...
    table: [{ 3: 1, 4: t, 7: 3, 12: 4, 28: e }, { 1: [3] }, n(s, [2, 3], { 5: 6 }), { 3: 7, 4: t, 7: 3, 12: 4, 28: e }, { 13: 8, 29: [1, 9] }, { 29: [2, 21] }, { 6: [1, 10], 7: 22, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: i, 18: o, 20: l, 22: g, 23: d, 24: 20, 25: 21, 26: y, 27: x, 28: e }, { 1: [2, 2] }, { 14: 25, 15: [1, 26], 31: w }, n([15, 31], [2, 22]), n(s, [2, 8], { 1: [2, 1] }), n(s, [2, 4]), { 7: 22, 10: 28, 12: 4, 17: i, 18: o, 20: l, 22: g, 23: d, 24: 20, 25: 21, 26: y, 27: x, 28: e }, n(s, [2, 6]), n(s, [2, 7]), n(s, [2, 11]), { 19: [1, 29] }, { 21: [1, 30] }, n(s, [2, 14]), n(s, [2, 15]), n(s, [2, 16]), n(s, [2, 17]), n(s, [2, 18]), n(s, [2, 19]), n(s, [2, 20]), { 11: [1, 31] }, { 16: 32, 30: [1, 33] }, { 11: [2, 24] }, n(s, [2, 5]), n(s, [2, 12]), n(s, [2, 13]), n(v, [2, 9]), { 14: 34, 31: w }, { 31: [2, 23] }, { 11: [1, 35] }, n(v, [2, 10])],
    ...
    parse: function(r) {
      var a = this, h = [0], u = [], f = [null], c = [], T = this.table, m = "", M = 0, z = 0, j = 2, K = 1, H = c.slice.call(arguments, 1), p = Object.create(this.lexer), E = { yy: {} };
      ...
      function et() {
        var P;
        return P = u.pop() || p.lex() || K, typeof P != "number" && (P instanceof Array && (u = P, P = u.pop()), P = a.symbols_[P] || P), P;
      }
      for (var k, R, $, Q, W = {}, G, A, nt, q; ; ) {
        if (R = h[h.length - 1], this.defaultActions[R] ? $ = this.defaultActions[R] : ((k === null || typeof k > "u") && (k = et()), $ = T[R] && T[R][k]), typeof $ > "u" || !$.length || !$[0]) {
          var X = "";
          q = [];
          for (G in T[R])
            this.terminals_[G] && G > j && q.push("'" + this.terminals_[G] + "'");
          p.showPosition ? X = "Parse error on line " + (M + 1) + `:
` + p.showPosition() + `
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : X = "Parse error on line " + (M + 1) + ": Unexpected " + (k == K ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(X, {
            text: p.match,
        ...
        switch ($[0]) {
          case 1:
            h.push(k), f.push(p.yytext), c.push(p.yylloc), h.push($[1]), k = null, z = p.yyleng, m = p.yytext, M = p.yylineno, C = p.yylloc;
            break;
          case 2:
            if (A = this.productions_[$[1]][1], W.$ = f[f.length - A], W._$ = {
              ...
              return Q;
            A && (h = h.slice(0, -1 * A * 2), f = f.slice(0, -1 * A), c = c.slice(0, -1 * A)), h.push(this.productions_[$[1]][0]), f.push(W.$), c.push(W._$), nt = T[h[h.length - 2]][h[h.length - 1]], h.push(nt);
            break;
          case 3:
            return !0;
        }
...
` + this.showPosition(), {
  ...
  return N.prototype = _, _.Parser = N, new N();
}();
Y.parser = Y;
const $t = Y;
let B = "", ct = 0;
const D = [], Z = [], O = [], lt = () => bt, ot = (n, t, e) => {
  vt(globalThis, n, t, e);
}, ht = function() {
  D.length = 0, Z.length = 0, B = "", O.length = 0, kt();
}, dt = function(n) {
  B = n, D.push(n);
}, ut = function() {
  return D;
  ...
  getTasks: pt,
  parseDirective: ot
}, Symbol.toStringTag, { value: "Module" })), Lt = 12, J = function(n, t) {
  ...
  function o(d) {
    const y = it().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    d.append("path").attr("class", "mouth").attr("d", y).attr("transform", "translate(" + t.cx + "," + (t.cy + 2) + ")");
  }
  function l(d) {
    const y = it().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    d.append("path").attr("class", "mouth").attr("d", y).attr("transform", "translate(" + t.cx + "," + (t.cy + 7) + ")");
  }
  function g(d) {
  ...
  return t.score > 3 ? o(i) : t.score < 3 ? l(i) : g(i), s;
}, Pt = function(n, t) {
  ...
  function e(i, o, l, g, d) {
    return i + "," + o + " " + (i + l) + "," + o + " " + (i + l) + "," + (o + g - d) + " " + (i + l - d * 1.2) + "," + (o + g) + " " + i + "," + (o + g);
  }
...
const zt = function(n, t, e) {
  ...
  const l = tt();
  l.x = t.x, l.y = t.y, l.fill = t.fill, l.width = e.width, l.height = e.height, l.class = "task task-type-" + t.num, l.rx = 3, l.ry = 3, J(i, l), t.x + 14, xt(e)(
    t.task,
    i,
    l.x,
    l.y,
  ...
  function n(i, o, l, g, d, y, x, w) {
    const v = o.append("text").attr("x", l + d / 2).attr("y", g + y / 2 + 5).style("font-color", w).style("text-anchor", "middle").text(i);
    s(v, x);
  }
  function t(i, o, l, g, d, y, x, w, v) {
    const { taskFontSize: _, taskFontFamily: S } = w, N = i.split(/<br\s*\/?>/gi);
    for (let b = 0; b < N.length; b++) {
      const r = b * _ - _ * (N.length - 1) / 2, a = o.append("text").attr("x", l + d / 2).attr("y", g).attr("fill", v).style("text-anchor", "middle").style("font-size", _).style("font-family", S);
      a.append("tspan").attr("x", l + d / 2).attr("dy", r).text(N[b]), a.attr("y", g + y / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), s(a, x);
    }
  }
  function e(i, o, l, g, d, y, x, w) {
    const v = o.append("switch"), S = v.append("foreignObject").attr("x", l).attr("y", g).attr("width", d).attr("height", y).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    S.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, v, l, g, d, y, x, w), s(S, x);
  }
  function s(i, o) {
    for (const l in o)
      l in o && i.attr(l, o[l]);
...
function _t(n, t) {
  n.each(function() {
    var e = U(this), s = e.text().split(/(\s+|<br>)/).reverse(), i, o = [], l = 1.1, g = e.attr("y"), d = parseFloat(e.attr("dy")), y = e.text(null).append("tspan").attr("x", 0).attr("y", g).attr("dy", d + "em");
    for (let x = 0; x < s.length; x++)
      i = s[s.length - 1 - x], o.push(i), y.text(o.join(" ").trim()), (y.node().getComputedTextLength() > t || i === "<br>") && (o.pop(), y.text(o.join(" ").trim()), i === "<br>" ? o = [""] : o = [i], y = e.append("tspan").attr("x", 0).attr("y", g).attr("dy", l + "em").text(i));
  });
}
const Wt = function(n, t, e, s) {
  ...
  const l = o.append("g"), g = o.append("g"), y = g.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(_t, t.width).node().getBBox(), x = s.fontSize && s.fontSize.replace ? s.fontSize.replace("px", "") : s.fontSize;
  return t.height = y.height + x * 1.1 * 0.5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width = t.width + 2 * t.padding, g.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), Ot(l, t, i), t;
}, Bt = function(n, t, e) {
  ...
  var i, o, l, g;
  const d = wt(), y = d.leftMargin ?? 50;
  (o = (i = s.db).clear) == null || o.call(i), s.parser.parse(n + `
`), I.debug("timeline", s.db);
  const x = d.securityLevel;
  let w;
  x === "sandbox" && (w = U("#i" + t));
  const _ = (x === "sandbox" ? U(w.nodes()[0].contentDocument.body) : U("body")).select("#" + t);
  _.append("g");
  const S = s.db.getTasks(), N = s.db.getCommonDb().getDiagramTitle();
  I.debug("task", S), F.initGraphics(_);
  const b = s.db.getSections();
  I.debug("sections", b);
  let r = 0, a = 0, h = 0, u = 0, f = 50 + y, c = 50;
  u = 50;
  let T = 0, m = !0;
  b.forEach(function(H) {
    const p = {
      ...
      padding: 20,
      maxHeight: r
    }, E = F.getVirtualNodeHeight(_, p, d);
    I.debug("sectionHeight before draw", E), r = Math.max(r, E + 20);
  });
  let M = 0, z = 0;
  I.debug("tasks.length", S.length);
  for (const [H, p] of S.entries()) {
    const E = {
      ...
      padding: 20,
      maxHeight: a
    }, L = F.getVirtualNodeHeight(_, E, d);
    I.debug("taskHeight before draw", L), a = Math.max(a, L + 20), M = Math.max(M, p.events.length);
    let C = 0;
    for (let V = 0; V < p.events.length; V++) {
      ...
      C += F.getVirtualNodeHeight(_, k, d);
    }
    z = Math.max(z, C);
  }
  I.debug("maxSectionHeight before draw", r), I.debug("maxTaskHeight before draw", a), b && b.length > 0 ? b.forEach((H) => {
    const p = S.filter((V) => V.section === H), E = {
      number: T,
      descr: H,
      section: T,
    ...
    I.debug("sectionNode", E);
    const L = _.append("g"), C = F.drawNode(L, E, T, d);
    I.debug("sectionNode output", C), L.attr("transform", `translate(${f}, ${u})`), c += r + 50, p.length > 0 && at(
      _,
      p,
      T,
      f,
      ...
      r,
      !1
    ), f += 200 * Math.max(p.length, 1), c = u, T++;
  }) : (m = !1, at(
    _,
    S,
    T,
  ...
  const j = _.node().getBBox();
  I.debug("bounds", j), N && _.append("text").text(N).attr("x", j.width / 2 - y).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), h = m ? r + a + 150 : a + 100, _.append("g").attr("class", "lineWrapper").append("line").attr("x1", y).attr("y1", h).attr("x2", j.width + 3 * y).attr("y2", h).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), St(
    void 0,
    _,
    ((l = d.timeline) == null ? void 0 : l.padding) ?? 50,
    ((g = d.timeline) == null ? void 0 : g.useMaxWidth) ?? !1
  );
}, at = function(n, t, e, s, i, o, l, g, d, y, x) {
  var w;
  for (const v of t) {
    const _ = {
      descr: v.task,
    ...
    I.debug("taskNode", _);
    const S = n.append("g").attr("class", "taskWrapper"), b = F.drawNode(S, _, e, l).height;
    if (I.debug("taskHeight after draw", b), S.attr("transform", `translate(${s}, ${i})`), o = Math.max(o, b), v.events) {
      const r = n.append("g").attr("class", "lineWrapper");
      let a = o;
      i += 100, a = a + Gt(n, v.events, e, s, i, l), i -= 100, r.append("line").attr("x1", s + 190 / 2).attr("y1", i + o).attr("x2", s + 190 / 2).attr(
        "y2",
        i + o + (x ? o : y) + d + 120
      ).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5");
    }
    s = s + 200, x && !((w = l.timeline) != null && w.disableMulticolor) && e++;
  }
  i = i - 10;
  ...
  for (const d of t) {
    ...
    I.debug("eventNode", y);
    const x = n.append("g").attr("class", "eventWrapper"), v = F.drawNode(x, y, e, o).height;
    l = l + v, x.attr("transform", `translate(${s}, ${i})`), i = i + 10 + v;
  }
  return i = g, l;
}, qt = {
  setConf: () => {
