import { p as Q, d as B, s as X, D as H, a as Z, S as F, b as j, c as I } from "./styles-47a825a5-c23f0608.js";
import { G as tt } from "./layout-ef28c229.js";
import { l, c as g, h as $, x as et, i as ot, k as G } from "./index-c335d62e.js";
import { r as st } from "./index-5219d011-d218db4e.js";
...
const h = (t, n, e, c, i, r) => {
  ...
  let p;
  i === "sandbox" && (p = $("#i" + n));
  const a = i === "sandbox" ? $(p.nodes()[0].contentDocument.body) : $("body"), d = a.select(`[id="${n}"]`), D = a.select("#" + n + " g");
  st(D, s, ["barb"], _, n);
  const S = 8;
  ...
  for (const x of J) {
    const O = x.getBBox(), b = document.createElementNS("http://www.w3.org/2000/svg", A);
    b.setAttribute("rx", 0), b.setAttribute("ry", 0), b.setAttribute("width", O.width), b.setAttribute("height", O.height), x.insertBefore(b, x.firstChild);
  }
}, Rt = {
  setConf: yt,
  getClasses: gt,
