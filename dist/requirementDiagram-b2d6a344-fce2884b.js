import { c as ve, s as Fe, g as Me, b as Pe, a as Ye, m as Ue, l as xe, E as Be, h as oe, i as Qe, j as Te } from "./index-d7731270.js";
import { G as He, l as We } from "./layout-4d485f0d.js";
import { l as Ke } from "./line-2938d916.js";
import "vue";
...
var he = function() {
  var e = function(q, r, s, l) {
    for (s = s || {}, l = q.length; l--; s[q[l]] = r)
      ;
    return s;
  }, t = [1, 3], a = [1, 5], o = [1, 6], d = [1, 7], u = [1, 8], p = [5, 6, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], h = [1, 22], c = [2, 13], g = [1, 26], R = [1, 27], v = [1, 28], S = [1, 29], T = [1, 30], x = [1, 31], A = [1, 24], N = [1, 32], w = [1, 33], pe = [1, 36], F = [71, 72], _e = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 60, 62, 71, 72], fe = [1, 56], ye = [1, 57], ge = [1, 58], Ee = [1, 59], Re = [1, 60], me = [1, 61], Ie = [1, 62], L = [62, 63], M = [1, 74], P = [1, 70], Y = [1, 71], U = [1, 72], B = [1, 73], Q = [1, 75], z = [1, 79], X = [1, 80], J = [1, 77], Z = [1, 78], m = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], re = {
    trace: function() {
    },
    yy: {},
    ...
    parse: function(r) {
      var s = this, l = [0], i = [], f = [null], n = [], K = this.table, _ = "", ee = 0, be = 0, Oe = 2, ke = 1, Le = n.slice.call(arguments, 1), E = Object.create(this.lexer), C = { yy: {} };
...
const je = {
  ...
  type: O.type,
  docRef: O.docRef
}, xe.info("Added new requirement: ", e)), O = {}, j[e]), lt = () => j, ct = (e) => {
  O !== void 0 && (O.type = e);
}, ot = (e) => {
  O !== void 0 && (O.docRef = e);
}, ht = (e, t, a) => {
...
const we = (e, t) => e.insert("rect", "#" + t).attr("class", "req reqBox").attr("x", 0).attr("y", 0).attr("width", y.rect_min_width + "px").attr("height", y.rect_min_height + "px"), Ve = (e, t, a) => {
  ...
  Object.keys(e).forEach((o) => {
    let d = e[o];
    o = W(o), xe.info("Added new requirement: ", o);
  ...
  let g = o.db.getRequirements(), R = o.db.getElements(), v = o.db.getRelationships();
  Rt(g, c, h), mt(R, c, h), It(v, c), We(c), bt(h, c), v.forEach(function(N) {
    Et(h, N, c, t, o);
  });
