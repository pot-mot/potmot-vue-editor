import { B as H, x as E, l as b, C as w } from "./index-54d0746e.js";
import { l as k } from "./line-a5be5e47.js";
let S = 0;
const O = function(i, e, t, n, r) {
  ...
  const l = e.points, d = k().x(function(o) {
    ...
    return o.y;
  }).curve(H), s = i.append("path").attr("d", d(l)).attr("id", "edge" + S).attr("class", "relation");
  let g = "";
  ...
  e.annotations.forEach(function(y) {
    const C = d.append("tspan").text("«" + y + "»");
    s || C.attr("dy", t.textHeight), s = !1;
  });
  let g = e.id;
