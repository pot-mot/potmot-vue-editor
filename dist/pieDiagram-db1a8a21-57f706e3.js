import { U as it, c as B, s as gt, g as dt, y as mt, z as _t, a as vt, b as kt, m as bt, k as xt, l as Y, A as St, h as nt, i as wt, V as At } from "./index-03ff04ff.js";
import { i as Et } from "./init-f9637058.js";
import { a as Dt } from "./array-2ff2c7a6.js";
import { c as j } from "./path-428ebac9.js";
import { a as lt } from "./arc-a0ef089e.js";
import "vue";
...
function Ot() {
  var t = Pt, s = Vt, l = null, o = j(0), p = j(it), g = j(0);
  function h(c) {
    var d, y = (c = Dt(c)).length, w, L, N = 0, x = new Array(y), A = new Array(y), $ = +o.apply(this, arguments), D = Math.min(it, Math.max(-it, p.apply(this, arguments) - $)), W, C = Math.min(Math.abs(D) / y, g.apply(this, arguments)), I = C * (D < 0 ? -1 : 1), v;
    for (d = 0; d < y; ++d)
      (v = A[x[d] = d] = +t(c[d], d, c)) > 0 && (N += v);
    for (s != null ? x.sort(function(E, k) {
      return s(A[E], A[k]);
    }) : l != null && x.sort(function(E, k) {
      return l(c[E], c[k]);
    }), d = 0, L = N ? (D - y * I) / N : 0; d < y; ++d, $ = W)
      w = x[d], v = A[w], W = $ + (v > 0 ? v * L : 0) + I, A[w] = {
        data: c[w],
        index: d,
        value: v,
        startAngle: $,
  ...
  return h.value = function(c) {
    return arguments.length ? (t = typeof c == "function" ? c : j(+c), h) : t;
    ...
    return arguments.length ? (o = typeof c == "function" ? c : j(+c), h) : o;
  }, h.endAngle = function(c) {
    return arguments.length ? (p = typeof c == "function" ? c : j(+c), h) : p;
  }, h.padAngle = function(c) {
    return arguments.length ? (g = typeof c == "function" ? c : j(+c), h) : g;
  }, h;
}
var rt = function() {
  var t = function(k, e, i, a) {
    for (i = i || {}, a = k.length; a--; i[k[a]] = e)
      ;
    return i;
  }, s = [1, 4], l = [1, 5], o = [1, 6], p = [1, 7], g = [1, 9], h = [1, 11, 13, 15, 17, 19, 20, 26, 27, 28, 29], c = [2, 5], d = [1, 6, 11, 13, 15, 17, 19, 20, 26, 27, 28, 29], y = [26, 27, 28], w = [2, 8], L = [1, 18], N = [1, 19], x = [1, 20], A = [1, 21], $ = [1, 22], D = [1, 23], W = [1, 28], C = [6, 26, 27, 28, 29], I = {
    trace: function() {
    },
    yy: {},
    ...
    parse: function(e) {
      var i = this, a = [0], n = [], u = [null], r = [], f = this.table, m = "", F = 0, q = 0, Q = 2, G = 1, ft = r.slice.call(arguments, 1), _ = Object.create(this.lexer), M = { yy: {} };
      ...
      function yt() {
        var P;
        return P = n.pop() || _.lex() || G, typeof P != "number" && (P instanceof Array && (n = P, P = n.pop()), P = i.symbols_[P] || P), P;
      }
      for (var b, z, S, tt, R = {}, H, V, at, J; ; ) {
        if (z = a[a.length - 1], this.defaultActions[z] ? S = this.defaultActions[z] : ((b === null || typeof b > "u") && (b = yt()), S = f[z] && f[z][b]), typeof S > "u" || !S.length || !S[0]) {
          var et = "";
          J = [];
          for (H in f[z])
...
Expecting ` + J.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : et = "Parse error on line " + (F + 1) + ": Unexpected " + (b == G ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(et, {
        ...
        switch (S[0]) {
          case 1:
            a.push(b), u.push(_.yytext), r.push(_.yylloc), a.push(S[1]), b = null, q = _.yyleng, m = _.yytext, F = _.yylineno, Z = _.yylloc;
            break;
          case 2:
...
const Nt = function(t, s, l) {
  bt.parseDirective(this, t, s, l);
}, Wt = function(t, s) {
  t = xt.sanitizeText(t, B()), K[t] === void 0 && (K[t] = s, Y.debug("Added new section :", t));
}, Ct = () => K, Ft = function(t) {
  st = t;
}, Mt = function() {
  return st;
...
`, Yt = Ut;
let T = B(), O;
const U = 450, Bt = (t, s, l, o) => {
  var p;
  try {
    T = B(), Y.debug(`Rendering info diagram
` + t);
    const v = B().securityLevel;
    let E;
    v === "sandbox" && (E = nt("#i" + s));
    ...
    O = i.parentElement.offsetWidth, O === void 0 && (O = 1200), T.useWidth !== void 0 && (O = T.useWidth), T.pie.useWidth !== void 0 && (O = T.pie.useWidth);
    const a = k.select("#" + s);
    wt(a, U, O, T.pie.useMaxWidth), i.setAttribute("viewBox", "0 0 " + O + " " + U);
    var g = 40, h = 18, c = 4, d = Math.min(O, U) / 2 - g, y = a.append("g").attr("transform", "translate(" + O / 2 + "," + U / 2 + ")"), w = o.db.getSections(), L = 0;
    ...
    const u = ((p = T.pie) == null ? void 0 : p.textPosition) ?? 0.75;
    ...
    }), D = $(A), W = lt().innerRadius(0).outerRadius(d), C = lt().innerRadius(d * u).outerRadius(d * u);
    ...
    }).style("text-anchor", "middle").attr("class", "slice"), y.append("text").text(o.db.getDiagramTitle()).attr("x", 0).attr("y", -(U - 50) / 2).attr("class", "pieTitleText");
    var I = y.selectAll(".legend").data(x.domain()).enter().append("g").attr("class", "legend").attr("transform", function(f, m) {
      const F = h + c, q = F * x.domain().length / 2, Q = 12 * h, G = m * F - q;
    ...
    I.append("rect").attr("width", h).attr("height", h).style("fill", x).style("stroke", x), I.data(D).append("text").attr("x", h + c).attr("y", h - c).text(function(f) {
      return o.db.getShowData() || T.showData || T.pie.showData ? f.data.name + " [" + f.data.value + "]" : f.data.name;
    });
  } catch (v) {
