import { l as nt, aw as At, aO as zt } from "./index-696d0216.js";
const It = {};
function Bt(n, r) {
  const t = r || It, e = typeof t.includeImageAlt == "boolean" ? t.includeImageAlt : !0, u = typeof t.includeHtml == "boolean" ? t.includeHtml : !0;
  return tt(n, e, u);
}
function tt(n, r, t) {
  if (Tt(n)) {
...
function Ot(n, r) {
  let t;
  for (t in r) {
    const u = (Hn.call(n, t) ? n[t] : void 0) || (n[t] = {}), i = r[t];
    let l;
    if (i)
      for (l in i) {
        Hn.call(u, l) || (u[l] = []);
...
const Pt = /[!-\/:-@\[-`\{-~\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]/, nn = cn(/[A-Za-z]/), v = cn(/[\dA-Za-z]/), _t = cn(/[#-'*+\--9=?A-Z^-~]/);
function An(n) {
  return (
...
const zn = cn(/\d/), Mt = cn(/[\dA-Fa-f]/), jt = cn(/[!-/:-@[-`{-~]/);
function w(n) {
  return n !== null && n < -2;
}
function Z(n) {
...
function O(n, r, t, e) {
  ...
  return l;
  function l(m) {
    return I(m) ? (n.enter(t), a(m)) : r(m);
  }
  function a(m) {
    return I(m) && i++ < u ? (n.consume(m), a) : (n.exit(t), r(m));
  }
}
const Ht = {
  tokenize: Nt
...
function Nt(n) {
  ...
  function l(a) {
    ...
    return w(a) ? (n.consume(a), n.exit("chunkText"), i) : (n.consume(a), l);
  }
}
const Vt = {
  tokenize: Qt
...
function Qt(n) {
  ...
  function a(F) {
    if (e < t.length) {
      const P = t[e];
      return r.containerState = P[1], n.attempt(
        P[0].continuation,
        m,
        c
      )(F);
  ...
  function m(F) {
    if (e++, r.containerState._closeFlow) {
      ...
      for (; B < r.events.length; )
        r.events[B][1].end = Object.assign({}, k), B++;
      return tn(
        r.events,
        M + 1,
        0,
        r.events.slice(P)
      ), r.events.length = B, c(F);
    }
    return a(F);
  }
  function c(F) {
  ...
  function C(F) {
    if (F === null) {
      D(n.exit("chunkFlow"), !0), b(0), n.consume(F);
      return;
    }
    return w(F) ? (n.consume(F), D(n.exit("chunkFlow")), e = 0, r.interrupt = void 0, a) : (n.consume(F), C);
  }
  function D(F, P) {
    const M = r.sliceStream(F);
    if (P && M.push(null), F.previous = i, i && (i.next = F), i = F, u.defineSkip(F.start), u.write(M), r.parser.lazy[F.start.line]) {
  ...
  function b(F) {
    ...
    for (; P-- > F; ) {
      const M = t[P];
      r.containerState = M[1], M[0].exit.call(r, n);
    }
    t.length = F;
  }
  function j() {
...
function $t(n, r) {
  ...
  function a(m) {
    ...
    const c = n.exit("attentionSequence"), p = Vn(m), f = !p || p === 2 && u || t.includes(m), x = !u || u === 2 && p || t.includes(e);
...
function Yt(n, r, t) {
  ...
  function c(h) {
    return h === 64 ? (n.consume(h), p) : _t(h) ? (n.consume(h), c) : t(h);
  }
  function p(h) {
    return v(h) ? f(h) : t(h);
  }
...
function Gt(n, r, t) {
  return e;
  function e(i) {
    return I(i) ? O(n, u, "linePrefix")(i) : u(i);
  }
  function u(i) {
...
function Jt(n, r, t) {
  ...
  function i(l) {
    return I(l) ? (n.enter("blockQuotePrefixWhitespace"), n.consume(l), n.exit("blockQuotePrefixWhitespace"), n.exit("blockQuotePrefix"), r) : (n.exit("blockQuotePrefix"), r(l));
  }
}
function Kt(n, r, t) {
  const e = this;
...
function ne(n, r, t) {
  ...
  function c(f) {
    return f === 88 || f === 120 ? (n.enter("characterReferenceMarkerHexadecimal"), n.consume(f), n.exit("characterReferenceMarkerHexadecimal"), n.enter("characterReferenceValue"), i = 6, l = Mt, p) : (n.enter("characterReferenceValue"), i = 7, l = zn, p(f));
  }
  function p(f) {
    if (f === 59 && u) {
      const x = n.exit("characterReferenceValue");
      return l === v && !Ln(e.sliceSerialize(x)) ? t(f) : (n.enter("characterReferenceMarker"), n.consume(f), n.exit("characterReferenceMarker"), n.exit("characterReference"), r);
    }
...
function te(n, r, t) {
  ...
  function c(k) {
    ...
    return i = B && B[1].type === "linePrefix" ? B[2].sliceSerialize(B[1], !0).length : 0, a = k, n.enter("codeFenced"), n.enter("codeFencedFence"), n.enter("codeFencedFenceSequence"), p(k);
  }
  function p(k) {
    return k === a ? (l++, n.consume(k), p) : l < 3 ? t(k) : (n.exit("codeFencedFenceSequence"), I(k) ? O(n, f, "whitespace")(k) : f(k));
  }
  function f(k) {
    return k === null || w(k) ? (n.exit("codeFencedFence"), e.interrupt ? r(k) : n.check(Wn, C, P)(k)) : (n.enter("codeFencedFenceInfo"), n.enter("chunkString", {
      contentType: "string"
    }), x(k));
  }
  function x(k) {
    return k === null || w(k) ? (n.exit("chunkString"), n.exit("codeFencedFenceInfo"), f(k)) : I(k) ? (n.exit("chunkString"), n.exit("codeFencedFenceInfo"), O(n, h, "whitespace")(k)) : k === 96 && k === a ? t(k) : (n.consume(k), x);
  }
  function h(k) {
    return k === null || w(k) ? f(k) : (n.enter("codeFencedFenceMeta"), n.enter("chunkString", {
      contentType: "string"
    }), A(k));
  }
  function A(k) {
    return k === null || w(k) ? (n.exit("chunkString"), n.exit("codeFencedFenceMeta"), f(k)) : k === 96 && k === a ? t(k) : (n.consume(k), A);
  }
  function C(k) {
    return n.attempt(u, P, D)(k);
  }
  function D(k) {
  ...
  function j(k) {
    return k === null || w(k) ? n.check(Wn, C, P)(k) : (n.enter("codeFlowValue"), F(k));
  }
  function F(k) {
    return k === null || w(k) ? (n.exit("codeFlowValue"), j(k)) : (n.consume(k), F);
  }
  function P(k) {
  ...
  function M(k, B, H) {
    ...
    return V;
    function V(z) {
      return k.enter("lineEnding"), k.consume(z), k.exit("lineEnding"), y;
    }
    function y(z) {
      return k.enter("codeFencedFence"), I(z) ? O(
        k,
        S,
        "linePrefix",
        e.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4
    ...
    function S(z) {
      return z === a ? (k.enter("codeFencedFenceSequence"), _(z)) : H(z);
    }
    function _(z) {
      return z === a ? (N++, k.consume(z), _) : N >= l ? (k.exit("codeFencedFenceSequence"), I(z) ? O(k, R, "whitespace")(z) : R(z)) : H(z);
    }
    function R(z) {
      return z === null || w(z) ? (k.exit("codeFencedFence"), B(z)) : H(z);
    }
  }
}
function ee(n, r, t) {
...
function ie(n, r, t) {
  ...
  function l(c) {
    return c === null ? m(c) : w(c) ? n.attempt(re, l, m)(c) : (n.enter("codeFlowValue"), a(c));
  }
  function a(c) {
    return c === null || w(c) ? (n.exit("codeFlowValue"), l(c)) : (n.consume(c), a);
  }
  function m(c) {
...
function ue(n, r, t) {
  ...
  return u;
  function u(l) {
    return e.parser.lazy[e.now().line] ? t(l) : w(l) ? (n.enter("lineEnding"), n.consume(l), n.exit("lineEnding"), u) : O(n, i, "linePrefix", 4 + 1)(l);
  }
  function i(l) {
    const a = e.events[e.events.length - 1];
    return a && a[1].type === "linePrefix" && a[2].sliceSerialize(a[1], !0).length >= 4 ? r(l) : w(l) ? u(l) : t(l);
  }
}
const le = {
  name: "codeText",
...
function se(n, r, t) {
  ...
  function m(f) {
    return f === null ? t(f) : f === 32 ? (n.enter("space"), n.consume(f), n.exit("space"), m) : f === 96 ? (i = n.enter("codeTextSequence"), u = 0, p(f)) : w(f) ? (n.enter("lineEnding"), n.consume(f), n.exit("lineEnding"), m) : (n.enter("codeTextData"), c(f));
  }
  function c(f) {
    return f === null || f === 32 || f === 96 || w(f) ? (n.exit("codeTextData"), m(f)) : (n.consume(f), c);
  }
  function p(f) {
...
function ut(n) {
  ...
  for (; ++t < n.length; ) {
    ...
    if (e[0] === "enter")
      e[1].contentType && (Object.assign(r, ce(n, t)), t = r[t], c = !0);
...
function ce(n, r) {
  ...
  for (h = t; ++x < a.length; )
    ...
    a[x][0] === "exit" && a[x - 1][0] === "enter" && a[x][1].type === a[x - 1][1].type && a[x][1].start.line !== a[x][1].end.line && (C = x + 1, D.push(C), h._tokenizer = void 0, h.previous = void 0, h = h.next);
  for (l.events = [], h ? (h._tokenizer = void 0, h.previous = void 0) : D.pop(), x = D.length; x--; ) {
    const b = a.slice(D[x], D[x + 1]), j = i.pop();
...
function lt(n, r, t, e, u, i, l, a, m) {
  ...
  function h(b) {
    return b === 62 ? (n.exit("chunkString"), n.exit(a), x(b)) : b === null || b === 60 || w(b) ? t(b) : (n.consume(b), b === 92 ? A : h);
  }
  function A(b) {
    return b === 60 || b === 62 || b === 92 ? (n.consume(b), h) : h(b);
  }
  function C(b) {
    return !p && (b === null || b === 41 || Z(b)) ? (n.exit("chunkString"), n.exit(a), n.exit(l), n.exit(e), r(b)) : p < c && b === 40 ? (n.consume(b), p++, C) : b === 41 ? (n.consume(b), p--, C) : b === null || b === 32 || b === 40 || An(b) ? t(b) : (n.consume(b), b === 92 ? D : C);
  }
  function D(b) {
...
function at(n, r, t, e, u, i) {
  ...
  function p(h) {
    ...
    /* c8 ignore next 3 */
    h === 94 && !a && "_hiddenFootnoteSupport" in l.parser.constructs ? t(h) : h === 93 ? (n.exit(i), n.enter(u), n.consume(h), n.exit(u), n.exit(e), r) : w(h) ? (n.enter("lineEnding"), n.consume(h), n.exit("lineEnding"), p) : (n.enter("chunkString", {
      contentType: "string"
    }), f(h));
  }
  function f(h) {
    return h === null || h === 91 || h === 93 || w(h) || a++ > 999 ? (n.exit("chunkString"), p(h)) : (n.consume(h), m || (m = !I(h)), h === 92 ? x : f);
  }
  function x(h) {
...
function ot(n, r, t, e, u, i) {
  ...
  function c(x) {
    return x === l ? (n.exit(i), m(l)) : x === null ? t(x) : w(x) ? (n.enter("lineEnding"), n.consume(x), n.exit("lineEnding"), O(n, c, "linePrefix")) : (n.enter("chunkString", {
      contentType: "string"
    }), p(x));
  }
  function p(x) {
    return x === l || x === null || w(x) ? (n.exit("chunkString"), c(x)) : (n.consume(x), x === 92 ? f : p);
  }
  function f(x) {
...
function dn(n, r) {
  ...
  return e;
  function e(u) {
    return w(u) ? (n.enter("lineEnding"), n.consume(u), n.exit("lineEnding"), t = !0, e) : I(u) ? O(
      n,
      e,
...
function de(n, r, t) {
  ...
  function p(h) {
    return n.attempt(ke, f, f)(h);
  }
  function f(h) {
    return I(h) ? O(n, x, "whitespace")(h) : x(h);
  }
  function x(h) {
    return h === null || w(h) ? (n.exit("definition"), e.parser.defined.push(u), r(h)) : t(h);
  }
}
function be(n, r, t) {
  return e;
  ...
  function i(a) {
    return I(a) ? O(n, l, "whitespace")(a) : l(a);
  }
  function l(a) {
    return a === null || w(a) ? r(a) : t(a);
  }
}
const ye = {
...
function we(n, r, t) {
  ...
  function a(p) {
    return p === 35 ? (n.enter("atxHeadingSequence"), m(p)) : p === null || w(p) ? (n.exit("atxHeading"), r(p)) : I(p) ? O(n, a, "whitespace")(p) : (n.enter("atxHeadingText"), c(p));
  }
  function m(p) {
...
const Ce = [
  ...
  "track",
  "ul"
], Zn = ["pre", "script", "style", "textarea"], Ae = {
  name: "htmlFlow",
  tokenize: Te,
  resolveTo: Be,
  concrete: !0
...
function Te(n, r, t) {
  ...
  function f(s) {
    return s === 33 ? (n.consume(s), x) : s === 47 ? (n.consume(s), i = !0, C) : s === 63 ? (n.consume(s), u = 3, e.interrupt ? r : o) : nn(s) ? (n.consume(s), l = String.fromCharCode(s), D) : t(s);
  }
  function x(s) {
  ...
  function C(s) {
    return nn(s) ? (n.consume(s), l = String.fromCharCode(s), D) : t(s);
  }
  function D(s) {
    if (s === null || s === 47 || s === 62 || Z(s)) {
      const K = s === 47, hn = l.toLowerCase();
      return !K && !i && Zn.includes(hn) ? (u = 1, e.interrupt ? r(s) : S(s)) : Ce.includes(l.toLowerCase()) ? (u = 6, K ? (n.consume(s), b) : e.interrupt ? r(s) : S(s)) : (u = 7, e.interrupt && !e.parser.lazy[e.now().line] ? t(s) : i ? j(s) : F(s));
    }
    return s === 45 || v(s) ? (n.consume(s), l += String.fromCharCode(s), D) : t(s);
  }
  function b(s) {
    return s === 62 ? (n.consume(s), e.interrupt ? r : S) : t(s);
  }
  function j(s) {
    return I(s) ? (n.consume(s), j) : V(s);
  }
  function F(s) {
    return s === 47 ? (n.consume(s), V) : s === 58 || s === 95 || nn(s) ? (n.consume(s), P) : I(s) ? (n.consume(s), F) : V(s);
  }
  function P(s) {
    return s === 45 || s === 46 || s === 58 || s === 95 || v(s) ? (n.consume(s), P) : M(s);
  }
  function M(s) {
    return s === 61 ? (n.consume(s), k) : I(s) ? (n.consume(s), M) : F(s);
  }
  function k(s) {
    return s === null || s === 60 || s === 61 || s === 62 || s === 96 ? t(s) : s === 34 || s === 39 ? (n.consume(s), m = s, B) : I(s) ? (n.consume(s), k) : H(s);
  }
  function B(s) {
    return s === m ? (n.consume(s), m = null, N) : s === null || w(s) ? t(s) : (n.consume(s), B);
  }
  function H(s) {
    return s === null || s === 34 || s === 39 || s === 47 || s === 60 || s === 61 || s === 62 || s === 96 || Z(s) ? M(s) : (n.consume(s), H);
  }
  function N(s) {
    return s === 47 || s === 62 || I(s) ? F(s) : t(s);
  }
  function V(s) {
    return s === 62 ? (n.consume(s), y) : t(s);
  }
  function y(s) {
    return s === null || w(s) ? S(s) : I(s) ? (n.consume(s), y) : t(s);
  }
  function S(s) {
    return s === 45 && u === 2 ? (n.consume(s), W) : s === 60 && u === 1 ? (n.consume(s), Q) : s === 62 && u === 4 ? (n.consume(s), J) : s === 63 && u === 3 ? (n.consume(s), o) : s === 93 && u === 5 ? (n.consume(s), en) : w(s) && (u === 6 || u === 7) ? (n.exit("htmlFlowData"), n.check(
      ze,
      rn,
      _
    )(s)) : s === null || w(s) ? (n.exit("htmlFlowData"), _(s)) : (n.consume(s), S);
  }
  function _(s) {
    return n.check(
      Ie,
  ...
  function z(s) {
    return s === null || w(s) ? _(s) : (n.enter("htmlFlowData"), S(s));
  }
  function W(s) {
  ...
  function G(s) {
    if (s === 62) {
      ...
      return Zn.includes(K) ? (n.consume(s), J) : S(s);
    }
  ...
  function J(s) {
    return s === null || w(s) ? (n.exit("htmlFlowData"), rn(s)) : (n.consume(s), J);
  }
  function rn(s) {
...
function Le(n, r, t) {
  ...
  return u;
  function u(l) {
    return w(l) ? (n.enter("lineEnding"), n.consume(l), n.exit("lineEnding"), i) : t(l);
  }
  function i(l) {
    return e.parser.lazy[e.now().line] ? t(l) : r(l);
  }
...
function Pe(n, r, t) {
  ...
  function m(o) {
    return o === 33 ? (n.consume(o), c) : o === 47 ? (n.consume(o), M) : o === 63 ? (n.consume(o), F) : nn(o) ? (n.consume(o), H) : t(o);
  }
  function c(o) {
  ...
  function f(o) {
    return o === null ? t(o) : o === 45 ? (n.consume(o), x) : w(o) ? (l = f, Q(o)) : (n.consume(o), f);
  }
  function x(o) {
    return o === 45 ? (n.consume(o), h) : f(o);
  }
  function h(o) {
    return o === 62 ? W(o) : o === 45 ? x(o) : f(o);
  }
  function A(o) {
    const J = "CDATA[";
    return o === J.charCodeAt(i++) ? (n.consume(o), i === J.length ? C : A) : t(o);
  }
  function C(o) {
    return o === null ? t(o) : o === 93 ? (n.consume(o), D) : w(o) ? (l = C, Q(o)) : (n.consume(o), C);
  }
  function D(o) {
    return o === 93 ? (n.consume(o), b) : C(o);
  }
  function b(o) {
    return o === 62 ? W(o) : o === 93 ? (n.consume(o), b) : C(o);
  }
  function j(o) {
    return o === null || o === 62 ? W(o) : w(o) ? (l = j, Q(o)) : (n.consume(o), j);
  }
  function F(o) {
    return o === null ? t(o) : o === 63 ? (n.consume(o), P) : w(o) ? (l = F, Q(o)) : (n.consume(o), F);
  }
  function P(o) {
    return o === 62 ? W(o) : F(o);
  }
  ...
  function k(o) {
    return o === 45 || v(o) ? (n.consume(o), k) : B(o);
  }
  function B(o) {
    return w(o) ? (l = B, Q(o)) : I(o) ? (n.consume(o), B) : W(o);
  }
  function H(o) {
    return o === 45 || v(o) ? (n.consume(o), H) : o === 47 || o === 62 || Z(o) ? N(o) : t(o);
  }
  function N(o) {
    return o === 47 ? (n.consume(o), W) : o === 58 || o === 95 || nn(o) ? (n.consume(o), V) : w(o) ? (l = N, Q(o)) : I(o) ? (n.consume(o), N) : W(o);
  }
  function V(o) {
    return o === 45 || o === 46 || o === 58 || o === 95 || v(o) ? (n.consume(o), V) : y(o);
  }
  function y(o) {
    return o === 61 ? (n.consume(o), S) : w(o) ? (l = y, Q(o)) : I(o) ? (n.consume(o), y) : N(o);
  }
  function S(o) {
    return o === null || o === 60 || o === 61 || o === 62 || o === 96 ? t(o) : o === 34 || o === 39 ? (n.consume(o), u = o, _) : w(o) ? (l = S, Q(o)) : I(o) ? (n.consume(o), S) : (n.consume(o), R);
  }
  function _(o) {
    return o === u ? (n.consume(o), u = void 0, z) : o === null ? t(o) : w(o) ? (l = _, Q(o)) : (n.consume(o), _);
  }
  function R(o) {
...
function Ge(n, r, t) {
  ...
  function a(c) {
    return c === u ? (n.enter("thematicBreakSequence"), m(c)) : e >= 3 && (c === null || w(c)) ? (n.exit("thematicBreak"), r(c)) : t(c);
  }
  function m(c) {
    return c === u ? (n.consume(c), e++, m) : (n.exit("thematicBreakSequence"), I(c) ? O(n, a, "whitespace")(c) : a(c));
  }
}
const $ = {
  name: "list",
...
function Xe(n, r, t) {
  ...
  function f(h) {
    return I(h) ? (n.enter("listItemPrefixWhitespace"), n.consume(h), n.exit("listItemPrefixWhitespace"), x) : t(h);
  }
  function x(h) {
...
function ve(n, r, t) {
  ...
  function i(a) {
    return e.containerState.furtherBlankLines || !I(a) ? (e.containerState.furtherBlankLines = void 0, e.containerState.initialBlankLine = void 0, l(a)) : (e.containerState.furtherBlankLines = void 0, e.containerState.initialBlankLine = void 0, n.attempt(Ke, r, l)(a));
  }
  function l(a) {
...
function er(n, r, t) {
  ...
  function u(i) {
    const l = e.events[e.events.length - 1];
    return !I(i) && l && l[1].type === "listItemPrefixWhitespace" ? r(i) : t(i);
  }
}
const Yn = {
...
function ir(n, r, t) {
  ...
  function a(c) {
    return c === u ? (n.consume(c), a) : (n.exit("setextHeadingLineSequence"), I(c) ? O(n, m, "lineSuffix")(c) : m(c));
  }
  function m(c) {
    return c === null || w(c) ? (n.exit("setextHeadingLine"), r(c)) : t(c);
  }
}
const ur = {
  tokenize: lr
...
function hr(n, r, t) {
  ...
  function f(y) {
    return l = Y(l, y), D(), l[l.length - 1] !== null ? [] : (H(r, 0), c.events = Tn(i, c.events, c), c.events);
  }
  function x(y, S) {
    return fr(h(y), S);
  }
  ...
  function A() {
    const { line: y, column: S, offset: _, _index: R, _bufferIndex: z } = e;
    return {
      line: y,
      column: S,
      offset: _,
  ...
  function j(y) {
    w(y) ? (e.line++, e.column = 1, e.offset += y === -3 ? 2 : 1, V()) : y !== -1 && (e.column++, e.offset++), e._bufferIndex < 0 ? e._index++ : (e._bufferIndex++, e._bufferIndex === l[e._index].length && (e._bufferIndex = -1, e._index++)), c.previous = y;
  }
  function F(y, S) {
    const _ = S || {};
    return _.type = y, _.start = A(), c.events.push(["enter", _, c]), a.push(_), _;
  }
  function P(y) {
    const S = a.pop();
  ...
  function B(y, S) {
    ...
    function _(R, z, W) {
      ...
      function J(U) {
        return pn;
        function pn(an) {
          const fn = an !== null && U[an], mn = an !== null && U.null, Fn = [
      ...
      function rn(U) {
        return Q = U, G = 0, U.length === 0 ? W : s(U[G]);
      }
      function s(U) {
        return pn;
        function pn(an) {
          return o = N(), en = U, U.partial || (c.currentConstruct = U), U.name && c.parser.constructs.disable.null.includes(U.name) ? hn() : U.tokenize.call(
      ...
      function hn(U) {
        return o.restore(), ++G < Q.length ? s(Q[G]) : W;
      }
    }
  }
  function H(y, S) {
  ...
  function N() {
    const y = A(), S = c.previous, _ = c.currentConstruct, R = c.events.length, z = Array.from(a);
    return {
      restore: W,
      from: R
    };
    function W() {
      e = y, c.previous = S, c.currentConstruct = _, c.events.length = R, a = z, V();
    }
  }
  function V() {
...
function Cr() {
  ...
  function u(i, l, a) {
    ...
    for (i = r + i.toString(l), f = 0, r = "", t && (i.charCodeAt(0) === 65279 && f++, t = void 0); f < i.length; ) {
      if (Gn.lastIndex = f, c = Gn.exec(i), x = c && c.index !== void 0 ? c.index : i.length, h = i.charCodeAt(x), !c) {
        r = i.slice(f);
        break;
      }
      if (h === 10 && f === x && e)
...
const zr = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
function Ir(n) {
  return n.replace(zr, Br);
}
function Br(n, r, t) {
  if (r)
    return r;
...
function yn(n) {
  return !n || typeof n != "object" ? "" : "position" in n || "type" in n ? Jn(n.position) : "start" in n || "end" in n ? Jn(n) : "line" in n || "column" in n ? Bn(n) : "";
}
function Bn(n) {
  return Kn(n && n.line) + ":" + Kn(n && n.column);
}
function Jn(n) {
  return Bn(n && n.start) + "-" + Bn(n && n.end);
}
function Kn(n) {
...
const pt = {}.hasOwnProperty, ft = (
   ...
   */
  function(n, r, t) {
    return typeof r != "string" && (t = r, r = void 0), Tr(t)(
      Ar(
        wr(t).document().write(Cr()(n, r, !0))
      )
    );
  }
);
function Tr(n) {
  ...
  function e(g) {
    ...
    for (L = -1; ++L < g.length; ) {
      const X = r[g[L][0]];
      pt.call(X, g[L][1].type) && X[g[L][1].type].call(
        Object.assign(
          {
    ...
    for (; ++T <= E; ) {
      ...
      if (q[1].type === "listUnordered" || q[1].type === "listOrdered" || q[1].type === "blockQuote" ? (q[0] === "enter" ? L++ : L--, kn = void 0) : q[1].type === "lineEndingBlank" ? q[0] === "enter" && (on && !kn && !L && !gn && (gn = T), kn = void 0) : q[1].type === "linePrefix" || q[1].type === "listItemValue" || q[1].type === "listItemMarker" || q[1].type === "listItemPrefix" || q[1].type === "listItemPrefixWhitespace" || (kn = void 0), !L && q[0] === "enter" && q[1].type === "listItemPrefix" || L === -1 && q[0] === "exit" && (q[1].type === "listUnordered" || q[1].type === "listOrdered")) {
        if (on) {
          ...
          ), g.splice(un || T, 0, ["exit", on, q[2]]), T++, E++;
        }
        ...
        }, g.splice(T, 0, ["enter", on, q[2]]), T++, E++, gn = void 0, kn = !0);
      }
    }
  ...
  function a(g, d) {
    return E;
    function E(T) {
      c.call(this, g(T), T), d && d.call(this, T);
    }
  }
  function m() {
    this.stack.push({
  ...
  function f(g, d) {
    const E = this.stack.pop(), T = this.tokenStack.pop();
    if (T)
      T[0].type !== g.type && (d ? d.call(this, g, T[0]) : (T[1] || Xn).call(this, g, T[0]));
    else
      throw new Error(
  ...
  function o(g) {
    ...
    E.label = Ir(d), E.identifier = xn(d).toLowerCase();
  }
  function J() {
  ...
  function an(g) {
    ...
    ), i("characterReferenceType")) : T = Ln(d);
    const L = this.stack.pop();
    L.value += T, L.position.end = sn(g.end);
  }
  function fn(g) {
    S.call(this, g);
    const d = this.stack[this.stack.length - 1];
...
function Dr(n) {
  const r = Or(n), { children: t } = ft(r), e = [[]];
  let u = 0;
...
function Mr(n, r, t, e, u = !1) {
  ...
  ), _r(l, r.labelStyle), l.style("display", "table-cell"), l.style("white-space", "nowrap"), l.style("max-width", t + "px"), l.attr("xmlns", "http://www.w3.org/1999/xhtml"), u && l.attr("class", "labelBkg");
...
function jr(n, r, t, e = !1) {
  const i = r.append("g");
  let l = i.insert("rect").attr("class", "background");
  const a = i.append("text").attr("y", "-10.1");
  let m = 0;
  if (t.forEach((c) => {
    let p = c.map((C) => C.content).join(" "), f = "", x = [], h = 0;
    if (vn(i, 1.1, p) <= n)
      x.push(p);
    else {
      for (let C = 0; C <= p.length; C++)
        if (f = p.slice(h, C), nt.info(f, h, C), vn(i, 1.1, f) > n) {
          const b = p.slice(h, C).lastIndexOf(" ");
          b > -1 && (C = h + b + 1), x.push(p.slice(h, C).trim()), h = C, f = null;
        }
      f != null && x.push(f);
    }
    const A = x.map((C) => ({ content: C, type: c.type }));
    for (const C of A) {
      let D = xt(a, m, 1.1);
      gt(D, [C]), m++;
    }
...
const qr = (n, r = "", {
  ...
  if (nt.info("createText", r, t, e, u, i, l, m), i) {
    const c = Pr(r), p = {
      isNode: l,
      label: At(c).replace(
        /fa[blrs]?:fa-[\w-]+/g,
