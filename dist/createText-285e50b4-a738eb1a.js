import { l as At, aw as zt, aO as It } from "./index-7301cf54.js";
const Tt = {};
function Bt(n, r) {
...
function nt(n, r, t) {
  if (Lt(n)) {
    ...
    if (r && "alt" in n && n.alt)
      return n.alt;
    if ("children" in n)
      return Hn(n.children, r, t);
  }
  return Array.isArray(n) ? Hn(n, r, t) : "";
}
function Hn(n, r, t) {
  const e = [];
  let u = -1;
...
function Dt(n, r) {
  let t;
  for (t in r) {
    const u = (Nn.call(n, t) ? n[t] : void 0) || (n[t] = {}), i = r[t];
    let l;
    if (i)
      for (l in i) {
        Nn.call(u, l) || (u[l] = []);
...
function Qt(n) {
  ...
  function I(F) {
    ...
    return w(F) ? (n.consume(F), M(n.exit("chunkFlow")), e = 0, r.interrupt = void 0, a) : (n.consume(F), I);
  }
  function M(F, D) {
...
function Zt(n, r) {
  const t = this.parser.constructs.attentionMarkers.null, e = this.previous, u = Wn(e);
  let i;
  return l;
  function l(m) {
  ...
  function a(m) {
    ...
    const c = n.exit("attentionSequence"), p = Wn(m), f = !p || p === 2 && u || t.includes(m), x = !u || u === 2 && p || t.includes(e);
...
function ee(n, r, t) {
  ...
  function f(k) {
    return k === null || w(k) ? (n.exit("codeFencedFence"), e.interrupt ? r(k) : n.check($n, I, D)(k)) : (n.enter("codeFencedFenceInfo"), n.enter("chunkString", {
      contentType: "string"
    }), x(k));
  }
  function x(k) {
    return k === null || w(k) ? (n.exit("chunkString"), n.exit("codeFencedFenceInfo"), f(k)) : z(k) ? (n.exit("chunkString"), n.exit("codeFencedFenceInfo"), O(n, h, "whitespace")(k)) : k === 96 && k === a ? t(k) : (n.consume(k), x);
  }
  function h(k) {
  ...
  function j(k) {
    return k === null || w(k) ? n.check($n, I, D)(k) : (n.enter("codeFlowValue"), F(k));
  }
  function F(k) {
  ...
  function _(k, T, H) {
    ...
    return V;
    function V(C) {
      return k.enter("lineEnding"), k.consume(C), k.exit("lineEnding"), y;
    }
    function y(C) {
      return k.enter("codeFencedFence"), z(C) ? O(
        k,
        S,
        "linePrefix",
        e.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4
    ...
    function S(C) {
      return C === a ? (k.enter("codeFencedFenceSequence"), P(C)) : H(C);
    }
    function P(C) {
      return C === a ? (N++, k.consume(C), P) : N >= l ? (k.exit("codeFencedFenceSequence"), z(C) ? O(k, R, "whitespace")(C) : R(C)) : H(C);
    }
    function R(C) {
      return C === null || w(C) ? (k.exit("codeFencedFence"), T(C)) : H(C);
    }
  }
}
function re(n, r, t) {
...
function ue(n, r, t) {
  ...
  function l(c) {
    return c === null ? m(c) : w(c) ? n.attempt(ie, l, m)(c) : (n.enter("codeFlowValue"), a(c));
  }
  function a(c) {
...
function lt(n, r, t, e, u, i) {
  ...
  function f(h) {
    return h === null || h === 91 || h === 93 || w(h) || a++ > 999 ? (n.exit("chunkString"), p(h)) : (n.consume(h), m || (m = !z(h)), h === 92 ? x : f);
  }
  function x(h) {
...
function dn(n, r) {
  ...
  return e;
  function e(u) {
    return w(u) ? (n.enter("lineEnding"), n.consume(u), n.exit("lineEnding"), t = !0, e) : z(u) ? O(
      n,
      e,
...
function Ce(n, r, t) {
  ...
  function a(p) {
    return p === 35 ? (n.enter("atxHeadingSequence"), m(p)) : p === null || w(p) ? (n.exit("atxHeading"), r(p)) : z(p) ? O(n, a, "whitespace")(p) : (n.enter("atxHeadingText"), c(p));
  }
  function m(p) {
...
const Ae = [
  ...
  "track",
  "ul"
], Yn = ["pre", "script", "style", "textarea"], ze = {
  name: "htmlFlow",
  tokenize: Le,
  resolveTo: Be,
  concrete: !0
...
function Le(n, r, t) {
  ...
  function M(s) {
    if (s === null || s === 47 || s === 62 || Z(s)) {
      ...
      return !K && !i && Yn.includes(hn) ? (u = 1, e.interrupt ? r(s) : S(s)) : Ae.includes(l.toLowerCase()) ? (u = 6, K ? (n.consume(s), b) : e.interrupt ? r(s) : S(s)) : (u = 7, e.interrupt && !e.parser.lazy[e.now().line] ? t(s) : i ? j(s) : F(s));
    }
  ...
  function T(s) {
    return s === m ? (n.consume(s), m = null, N) : s === null || w(s) ? t(s) : (n.consume(s), T);
  }
  function H(s) {
  ...
  function y(s) {
    return s === null || w(s) ? S(s) : z(s) ? (n.consume(s), y) : t(s);
  }
  function S(s) {
    return s === 45 && u === 2 ? (n.consume(s), U) : s === 60 && u === 1 ? (n.consume(s), W) : s === 62 && u === 4 ? (n.consume(s), J) : s === 63 && u === 3 ? (n.consume(s), o) : s === 93 && u === 5 ? (n.consume(s), en) : w(s) && (u === 6 || u === 7) ? (n.exit("htmlFlowData"), n.check(
      Ie,
      rn,
      P
    )(s)) : s === null || w(s) ? (n.exit("htmlFlowData"), P(s)) : (n.consume(s), S);
  }
  function P(s) {
    return n.check(
      Te,
  ...
  function R(s) {
    return n.enter("lineEnding"), n.consume(s), n.exit("lineEnding"), C;
  }
  function C(s) {
    return s === null || w(s) ? P(s) : (n.enter("htmlFlowData"), S(s));
  }
  function U(s) {
  ...
  function G(s) {
    if (s === 62) {
      ...
      return Yn.includes(K) ? (n.consume(s), J) : S(s);
    }
...
function _e(n, r, t) {
  ...
  function f(o) {
    return o === null ? t(o) : o === 45 ? (n.consume(o), x) : w(o) ? (l = f, W(o)) : (n.consume(o), f);
  }
  function x(o) {
  ...
  function I(o) {
    return o === null ? t(o) : o === 93 ? (n.consume(o), M) : w(o) ? (l = I, W(o)) : (n.consume(o), I);
  }
  function M(o) {
  ...
  function j(o) {
    return o === null || o === 62 ? U(o) : w(o) ? (l = j, W(o)) : (n.consume(o), j);
  }
  function F(o) {
    return o === null ? t(o) : o === 63 ? (n.consume(o), D) : w(o) ? (l = F, W(o)) : (n.consume(o), F);
  }
  function D(o) {
    return o === 62 ? U(o) : F(o);
  }
  ...
  function T(o) {
    return w(o) ? (l = T, W(o)) : z(o) ? (n.consume(o), T) : U(o);
  }
  function H(o) {
    return o === 45 || v(o) ? (n.consume(o), H) : o === 47 || o === 62 || Z(o) ? N(o) : t(o);
  }
  function N(o) {
    return o === 47 ? (n.consume(o), U) : o === 58 || o === 95 || nn(o) ? (n.consume(o), V) : w(o) ? (l = N, W(o)) : z(o) ? (n.consume(o), N) : U(o);
  }
  function V(o) {
    return o === 45 || o === 46 || o === 58 || o === 95 || v(o) ? (n.consume(o), V) : y(o);
  }
  function y(o) {
    return o === 61 ? (n.consume(o), S) : w(o) ? (l = y, W(o)) : z(o) ? (n.consume(o), y) : N(o);
  }
  function S(o) {
    return o === null || o === 60 || o === 61 || o === 62 || o === 96 ? t(o) : o === 34 || o === 39 ? (n.consume(o), u = o, P) : w(o) ? (l = S, W(o)) : z(o) ? (n.consume(o), S) : (n.consume(o), R);
  }
  function P(o) {
    return o === u ? (n.consume(o), u = void 0, C) : o === null ? t(o) : w(o) ? (l = P, W(o)) : (n.consume(o), P);
  }
  function R(o) {
...
function pr(n, r, t) {
  ...
  function A() {
    const { line: y, column: S, offset: P, _index: R, _bufferIndex: C } = e;
    return {
      line: y,
      column: S,
      offset: P,
  ...
  function N() {
    const y = A(), S = c.previous, P = c.currentConstruct, R = c.events.length, C = Array.from(a);
    return {
      restore: U,
      from: R
    };
    function U() {
      e = y, c.previous = S, c.currentConstruct = P, c.events.length = R, a = C, V();
    }
  }
  function V() {
...
function Ar() {
  ...
  function u(i, l, a) {
    ...
    for (i = r + i.toString(l), f = 0, r = "", t && (i.charCodeAt(0) === 65279 && f++, t = void 0); f < i.length; ) {
      if (Jn.lastIndex = f, c = Jn.exec(i), x = c && c.index !== void 0 ? c.index : i.length, h = i.charCodeAt(x), !c) {
        r = i.slice(f);
        break;
      }
      if (h === 10 && f === x && e)
...
function Br(n, r, t) {
  ...
  if (t.charCodeAt(0) === 35) {
    ...
    return ct(t.slice(i ? 2 : 1), i ? 16 : 10);
  }
  return On(t) || n;
}
function yn(n) {
...
function Lr(n) {
  ...
  function e(g) {
    ...
    for (L = -1; ++L < g.length; ) {
      const X = r[g[L][0]];
      ht.call(X, g[L][1].type) && X[g[L][1].type].call(
        Object.assign(
          {
  ...
  function f(g, d) {
    ...
    if (B)
      B[0].type !== g.type && (d ? d.call(this, g, B[0]) : (B[1] || vn).call(this, g, B[0]));
    else
      throw new Error(
...
function Pr(n) {
  const r = Dr(n), { children: t } = pt(r), e = [[]];
  let u = 0;
...
function mt(n, r, t, e) {
  ...
  const [u, ...i] = t, l = [...r, u];
  return n([{ content: l.join(""), type: e }]) ? mt(n, l, i, e) : (r.length === 0 && u && (r.push(u), t.shift()), [
    { content: r.join(""), type: e },
