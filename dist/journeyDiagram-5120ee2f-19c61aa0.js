import { c as V, B as gt, D as mt, s as xt, g as _t, b as kt, a as bt, m as vt, E as wt, h as H, i as Tt } from "./index-f3a6ba52.js";
import { d as $t, f as St, a as Mt, g as ot } from "./svgDrawCommon-f26cad39-7112b90c.js";
import { a as it } from "./arc-0ced6540.js";
import "vue";
...
var Z = function() {
  var t = function(_, r, a, h) {
    ...
    parse: function(r) {
      ...
      v.setInput(r, I.yy), I.yy.lexer = v, I.yy.parser = this, typeof v.yylloc > "u" && (v.yylloc = {});
      var W = v.yylloc;
      o.push(W);
      ...
      for (var w, A, $, X, F = {}, Y, M, et, O; ; ) {
        if (A = h[h.length - 1], this.defaultActions[A] ? $ = this.defaultActions[A] : ((w === null || typeof w > "u") && (w = ft()), $ = R[A] && R[A][w]), typeof $ > "u" || !$.length || !$[0]) {
          var G = "";
          O = [];
          for (Y in R[A])
...
Expecting ` + O.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : G = "Parse error on line " + (z + 1) + ": Unexpected " + (w == tt ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(G, {
        ...
        switch ($[0]) {
          case 1:
            h.push(w), m.push(v.yytext), o.push(v.yylloc), h.push($[1]), w = null, Q = v.yyleng, k = v.yytext, z = v.yylineno, W = v.yylloc;
            break;
          case 2:
...
const qt = function(t, e, s) {
  ...
  nt++;
  const l = 300 + 5 * 30;
  i.append("line").attr("id", "task" + nt).attr("x1", n).attr("y1", e.y).attr("x2", n).attr("y2", l).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), zt(i, {
    cx: n,
    cy: 300 + (5 - e.score) * 30,
    score: e.score
  });
...
const q = V().journey, C = q.leftMargin, Ht = function(t, e, s, n) {
  ...
  for (const [f, d] of e.entries()) {
    ...
    d.x = f * n.taskMargin + f * n.width + C, d.y = c, d.width = n.diagramMarginX, d.height = n.diagramMarginY, d.colour = x, d.fill = u, d.num = g, d.actors = T, j.drawTask(t, d, n), S.insert(d.x, d.y, d.x + d.width + n.taskMargin, 300 + 5 * 30);
  }
}, ct = {
  setConf: Xt,
  draw: Ht
