import { i as V, G as q } from "./layout-ef28c229.js";
import { v as M, o as N, l as u, p as R, c as C, k as I, q as $, r as E, h as _, x as F, t as U } from "./index-c335d62e.js";
import { f as H } from "./flowDb-52e24d17-4715d4b3.js";
import { r as W } from "./index-5219d011-d218db4e.js";
import { s as X } from "./selectAll-4fb9119b.js";
function se(e, l) {
...
`), s.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + k + " " + h, l.setEdge(s.start, s.end, t, a);
  ...
  u.info("Drawing flowchart"), a.db.clear(), H.setGen("gen-2"), a.parser.parse(e);
  ...
  if (W(m, t, ["point", "circle", "cross"], "flowchart", l), F.insertTitle(T, "flowchartTitleText", w.titleTopMargin, a.db.getDiagramTitle()), U(t, T, w.diagramPadding, w.useMaxWidth), a.db.indexNodes("subGraph" + g), !w.htmlLabels) {
