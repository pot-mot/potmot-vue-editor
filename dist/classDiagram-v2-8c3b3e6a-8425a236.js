import { p as I, d as N, s as M } from "./styles-88ad4441-19b9b5a1.js";
import { l as d, c, h as w, z as R, t as B, q as E, r as _, o as G, j as C } from "./index-50f8b7ff.js";
import { G as z } from "./layout-d7f24083.js";
import { r as q } from "./index-4c4adb72-68be036e.js";
import "vue";
...
`), e.style === void 0 && (o.style = o.style || "stroke: #333; stroke-width: 1.5px;fill:none"), o.labelStyle = o.labelStyle.replace("color:", "fill:"))), t.setEdge(e.id1, e.id2, o, n);
  ...
  let b;
  i === "sandbox" && (b = w("#i" + t));
  const m = i === "sandbox" ? w(b.nodes()[0].contentDocument.body) : w("body"), u = m.select(`[id="${t}"]`), g = m.select("#" + t + " g");
  if (await q(
    g,
    l,
    ...
    for (const x of $) {
      const L = x.getBBox(), v = T.createElementNS("http://www.w3.org/2000/svg", "rect");
      v.setAttribute("rx", 0), v.setAttribute("ry", 0), v.setAttribute("width", L.width), v.setAttribute("height", L.height), x.insertBefore(v, x.firstChild);
    }
  }
};
function D(s) {
