import { p as H, c as w, d as Z, aw as j, h as B, l as x, z as U, F } from "./index-20be57f3.js";
import { c as P } from "./createText-285e50b4-d437b8b2.js";
import { p as Q } from "./svgDraw-5d8a058e-cc19591e.js";
import { l as et } from "./line-bfb82ed8.js";
const st = (r, t, e, n) => {
  t.forEach((a) => {
    yt[a](r, e, n);
  });
...
function xt(r) {
  const t = B(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), e = t.append("xhtml:div"), n = r.label, a = r.isNode ? "nodeLabel" : "edgeLabel";
  return e.html(
...
const gt = (r, t, e, n) => {
  ...
  const o = l.node();
  let h;
  t.labelType === "markdown" ? h = P(l, Z(j(c), w()), {
    useHtmlLabels: s,
  ...
  if (H(w().flowchart.htmlLabels)) {
    const d = h.children[0], p = B(h), y = d.getElementsByTagName("img");
    if (y) {
          ...
          (u) => new Promise((I) => {
            function T() {
              if (u.style.display = "flex", u.style.flexDirection = "column", g) {
                const M = w().fontSize ? w().fontSize : window.getComputedStyle(document.body).fontSize, _ = 5;
                u.style.width = parseInt(M, 10) * _ + "px";
              } else
                u.style.width = "100%";
              I(u);
            }
...
function mt(r, t, e, n) {
  var a, s, i, l, c, o, h, f, b, d, p, y, g, u, I;
  if (a = t.y - r.y, i = r.x - t.x, c = t.x * r.y - r.x * t.y, b = a * e.x + i * e.y + c, d = a * n.x + i * n.y + c, !(b !== 0 && d !== 0 && V(b, d)) && (s = n.y - e.y, l = e.x - n.x, o = n.x * e.y - e.x * n.y, h = s * r.x + l * r.y + o, f = s * t.x + l * t.y + o, !(h !== 0 && f !== 0 && V(h, f)) && (p = a * l - s * i, p !== 0)))
    return y = Math.abs(p / 2), g = i * o - l * c, u = g < 0 ? (g - y) / p : (g + y) / p, g = s * c - a * o, I = g < 0 ? (g - y) / p : (g + y) / p, { x: u, y: I };
}
function V(r, t) {
  return r * t > 0;
}
function kt(r, t, e) {
  ...
  return s.length ? (s.length > 1 && s.sort(function(p, y) {
    var g = p.x - e.x, u = p.y - e.y, I = Math.sqrt(g * g + u * u), T = y.x - e.x, M = y.y - e.y, _ = Math.sqrt(T * T + M * M);
    return I < _ ? -1 : I === _ ? 0 : 1;
  }), s[0]) : r;
}
const vt = (r, t) => {
  ...
  const { shapeSvg: n, bbox: a, halfPadding: s } = await E(
    r,
    t,
    "node " + t.classes,
    !0
  ...
  const { shapeSvg: e, bbox: n } = await E(r, t, void 0, !0), a = n.width + t.padding, s = n.height + t.padding, i = a + s, l = [
    { x: i / 2, y: 0 },
    { x: i, y: -i / 2 },
    { x: i / 2, y: -i },
    { x: 0, y: -i / 2 }
  ...
  const { shapeSvg: e, bbox: n } = await E(r, t, void 0, !0), a = 4, s = n.height + t.padding, i = s / a, l = n.width + 2 * i + t.padding, c = [
    { x: i, y: 0 },
    { x: l - i, y: 0 },
    { x: l, y: -s / 2 },
    { x: l - i, y: -s },
  ...
  const { shapeSvg: e, bbox: n } = await E(r, t, void 0, !0), a = n.width + t.padding, s = n.height + t.padding, i = [
    { x: -s / 2, y: 0 },
    { x: a, y: 0 },
    { x: a, y: -s },
    { x: -s / 2, y: -s },
  ...
  const { shapeSvg: e, bbox: n } = await E(r, t, void 0, !0), a = n.width + t.padding, s = a / 2, i = s / (2.5 + a / 50), l = n.height + i + t.padding, c = "M 0," + i + " a " + s + "," + i + " 0,0,0 " + a + " 0 a " + s + "," + i + " 0,0,0 " + -a + " 0 l 0," + l + " a " + s + "," + i + " 0,0,0 " + a + " 0 l 0," + -l, o = e.attr("label-offset-y", i).insert("path", ":first-child").attr("style", t.style).attr("d", c).attr("transform", "translate(" + -a / 2 + "," + -(l / 2 + i) + ")");
  ...
  const { shapeSvg: e, bbox: n, halfPadding: a } = await E(
    r,
    t,
    "node " + t.classes,
    !0
  ...
  const { shapeSvg: e } = await E(r, t, "label", !0);
...
const Xt = (r, t) => {
  ...
  const { shapeSvg: e, bbox: n } = await E(r, t, void 0, !0), a = n.height + t.padding, s = n.width + a / 4 + t.padding, i = e.insert("rect", ":first-child").attr("style", t.style).attr("rx", a / 2).attr("ry", a / 2).attr("x", -s / 2).attr("y", -a / 2).attr("width", s).attr("height", a);
  return k(t, i), t.intersect = function(l) {
    return m.rect(t, l);
  }, e;
}, Ut = async (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = await E(r, t, void 0, !0), s = e.insert("circle", ":first-child");
  ...
  const { shapeSvg: e, bbox: n, halfPadding: a } = await E(r, t, void 0, !0), s = 5, i = e.insert("g", ":first-child"), l = i.insert("circle"), c = i.insert("circle");
  ...
  let d = 0;
  const p = t.classData.annotations && t.classData.annotations[0], y = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", g = b.node().appendChild(R(y, t.labelStyle, !0, !0));
  let u = g.getBBox();
  if (H(w().flowchart.htmlLabels)) {
    const v = g.children[0], L = B(g);
    u = v.getBoundingClientRect(), L.attr("width", u.width), L.attr("height", u.height);
  }
  t.classData.annotations[0] && (f += u.height + n, h += u.width);
  ...
  const T = b.node().appendChild(R(I, t.labelStyle, !0, !0));
  B(T).attr("class", "classTitle");
  let M = T.getBBox();
  if (H(w().flowchart.htmlLabels)) {
    const v = T.children[0], L = B(T);
  ...
  return B(T).attr(
  ...
  ), d += M.height + n, c.attr("class", "divider").attr("x1", -h / 2 - e).attr("x2", h / 2 + e).attr("y1", -f / 2 - e + a + d).attr("y2", -f / 2 - e + a + d), d += a, _.forEach((v) => {
    B(v).attr(
      "transform",
  ...
  }), d += a, o.attr("class", "divider").attr("x1", -h / 2 - e).attr("x2", h / 2 + e).attr("y1", -f / 2 - e + a + d).attr("y2", -f / 2 - e + a + d), d += a, z.forEach((v) => {
    B(v).attr(
      "transform",
    ...
    const L = v == null ? void 0 : v.getBBox();
    d += ((L == null ? void 0 : L.height) ?? 0) + n;
  }), l.attr("class", "outer title-state").attr("x", -h / 2 - e).attr("y", -(f / 2) - e).attr("width", h + t.padding).attr("height", f + t.padding), k(t, l), t.intersect = function(v) {
    return m.rect(t, v);
  }, i;
}, K = {
  rhombus: J,
...
const ar = () => {
  ...
  if (t.startLabelLeft) {
    ...
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), S[t.id] || (S[t.id] = {}), S[t.id].startLeft = o, A(l, t.startLabelLeft);
  }
  if (t.startLabelRight) {
    ...
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), S[t.id] || (S[t.id] = {}), S[t.id].startRight = o, A(l, t.startLabelRight);
  }
  if (t.endLabelLeft) {
    const c = R(t.endLabelLeft, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    l = h.node().appendChild(c);
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), o.node().appendChild(c), S[t.id] || (S[t.id] = {}), S[t.id].endLeft = o, A(l, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const c = R(t.endLabelRight, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    l = h.node().appendChild(c);
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), o.node().appendChild(c), S[t.id] || (S[t.id] = {}), S[t.id].endRight = o, A(l, t.endLabelRight);
  }
  return n;
};
function A(r, t) {
...
const sr = (r, t) => {
  ...
  const h = i.filter((u) => !Number.isNaN(u.y));
  let f;
  a === "graph" || a === "flowchart" ? f = e.curve || F : f = F;
  const b = et().x(function(u) {
    return u.x;
  }).y(function(u) {
    return u.y;
  }).curve(f);
