import { p as mn, f as Et } from "./flowDb-8f9fc471-ac2a2c8f.js";
import { h as S, u as bn, r as kn, p as Sn, l as $n, d as J, f as be, G as Nn } from "./layout-a27f1bdd.js";
import { h as et, o as It, p as ke, c as Kt, j as Se, l as O, q as Tt, r as Mt, t as An } from "./index-d4cef695.js";
import { a as F, b as $e, i as Ne, c as M, e as Ae, d as Ee, f as En, g as Tn, s as Mn } from "./styles-ff678862-b0afca22.js";
import "vue";
...
var Rn = In("image/svg+xml"), Dn = { value: () => {
} };
function Te() {
...
gt.prototype = Te.prototype = {
  constructor: gt,
  on: function(t, e) {
    var n = this._, r = Pn(t + "", n), i, a = -1, s = r.length;
...
function sr(t, e) {
  ...
  for (var a = i.length, s = new Array(a), o = new Array(a), l = new Array(a), u = 0; u < a; ++u) {
    ...
    n(c, h, y, g, v, d, e);
    for (var w = 0, k = 0, _, D; w < p; ++w)
      if (_ = y[w]) {
        for (w >= k && (k = w + 1); !(D = g[k]) && ++k < p; )
          ;
        _._next = D || null;
      }
  }
...
function Nr(t, e) {
  ...
  return this.each((e == null ? n.local ? mr : _r : typeof e == "function" ? n.local ? $r : Sr : n.local ? kr : br)(n, e));
}
function De(t) {
...
function Fr(t, e) {
  ...
  return this.each((typeof e == "function" ? Br : e ? Dr : Pr)(n, e));
}
function Hr() {
  this.textContent = "";
}
...
var at = 0.7, xt = 1 / at, K = "\\s*([+-]?\\d+)\\s*", st = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", L = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", yi = /^#([0-9a-f]{3,8})$/, vi = new RegExp(`^rgb\\(${K},${K},${K}\\)$`), wi = new RegExp(`^rgb\\(${L},${L},${L}\\)$`), xi = new RegExp(`^rgba\\(${K},${K},${K},${st}\\)$`), _i = new RegExp(`^rgba\\(${L},${L},${L},${st}\\)$`), mi = new RegExp(`^hsl\\(${st},${L},${L}\\)$`), bi = new RegExp(`^hsla\\(${st},${L},${L},${st}\\)$`), se = {
  aliceblue: 15792383,
...
function ot(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = yi.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? ce(e) : n === 3 ? new $(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? ht(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? ht(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = vi.exec(t)) ? new $(e[1], e[2], e[3], 1) : (e = wi.exec(t)) ? new $(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = xi.exec(t)) ? ht(e[1], e[2], e[3], e[4]) : (e = _i.exec(t)) ? ht(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = mi.exec(t)) ? he(e[1], e[2] / 100, e[3] / 100, 1) : (e = bi.exec(t)) ? he(e[1], e[2] / 100, e[3] / 100, e[4]) : se.hasOwnProperty(t) ? ce(se[t]) : t === "transparent" ? new $(NaN, NaN, NaN, 0) : null;
}
function ce(t) {
...
Jt($, Dt, Ue(ut, {
  brighter(t) {
    return t = t == null ? xt : Math.pow(xt, t), new $(this.r * t, this.g * t, this.b * t, this.opacity);
  },
  darker(t) {
  ...
  clamp() {
    return new $(G(this.r), G(this.g), G(this.b), _t(this.opacity));
  },
  displayable() {
...
Jt(T, Ai, Ue(ut, {
  brighter(t) {
    return t = t == null ? xt : Math.pow(xt, t), new T(this.h, this.s, this.l * t, this.opacity);
  },
  darker(t) {
  ...
  clamp() {
    return new T(de(this.h), dt(this.s), dt(this.l), _t(this.opacity));
  },
  displayable() {
...
const pe = function t(e) {
  var n = Mi(e);
  function r(i, a) {
    var s = n((i = Dt(i)).r, (a = Dt(a)).r), o = n(i.g, a.g), l = n(i.b, a.b), u = Ye(i.opacity, a.opacity);
    return function(c) {
...
var Pt = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Lt = new RegExp(Pt.source, "g");
function Ci(t) {
  return function() {
    return t;
  };
...
function Ii(t, e) {
  var n = Pt.lastIndex = Lt.lastIndex = 0, r, i, a, s = -1, o = [], l = [];
  for (t = t + "", e = e + ""; (r = Pt.exec(t)) && (i = Lt.exec(e)); )
...
var Pi = We(Ri, "px, ", "px)", "deg)"), Bi = We(Di, ", ", ")", ")"), Z = 0, nt = 0, j = 0, Oe = 1e3, mt, rt, bt = 0, Y = 0, $t = 0, lt = typeof performance == "object" && performance.now ? performance : Date, Ke = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function jt() {
  return Y || (Ke(Fi), Y = lt.now() + $t);
}
function Fi() {
  Y = 0;
}
...
var Ui = Te("start", "end", "cancel", "interrupt"), Vi = [], Ze = 0, we = 1, Ht = 2, yt = 3, xe = 4, Xt = 5, vt = 6;
  ...
  function s(u) {
    ...
    for (c in r)
      if (d = r[c], d.name === n.name) {
        if (d.state === yt)
          return ve(s);
        d.state === xe ? (d.state = vt, d.timer.stop(), d.on.call("interrupt", t, t.__data__, d.index, d.group), delete r[c]) : +c < e && (d.state = vt, d.timer.stop(), d.on.call("cancel", t, t.__data__, d.index, d.group), delete r[c]);
      }
    if (ve(function() {
      n.state === yt && (n.state = xe, n.timer.restart(o, n.delay, n.time), o(u));
  ...
  arcTo(e, n, r, i, a) {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(h * l - u * c) > U) || !a)
        ...
        let d = r - s, p = i - o, y = l * l + u * u, g = d * d + p * p, v = Math.sqrt(y), w = Math.sqrt(f), k = a * Math.tan((qt - Math.acos((y + f - g) / (2 * v * w))) / 2), _ = k / w, D = k / v;
        Math.abs(_ - 1) > U && this._append`L${e + _ * c},${n + _ * h}`, this._append`A${a},${a},0,0,${+(h * d > c * p)},${this._x1 = e + D * l},${this._y1 = n + D * u}`;
      }
  }
  arc(e, n, r, i, a, s) {
...
function rs(t, e) {
  var n = W(!0), r = null, i = rn, a = null, s = ja(o);
  t = typeof t == "function" ? t : t === void 0 ? es : W(t), e = typeof e == "function" ? e : e === void 0 ? ns : W(e);
  function o(l) {
...
function gs(t, e) {
  ...
  return a.unshift(_e(r, a[0])), a.push(_e(i, a[a.length - 1])), an(n, a);
}
function an(t, e) {
...
function R(t, e, n) {
  ...
  return a.length ? (a.length > 1 && a.sort(function(p, y) {
    var g = p.x - n.x, v = p.y - n.y, w = Math.sqrt(g * g + v * v), k = y.x - n.x, _ = y.y - n.y, D = Math.sqrt(k * k + _ * _);
    return w < D ? -1 : w === D ? 0 : 1;
...
function Ms() {
  ...
  return t.createNodes = function(e) {
    return arguments.length ? (xs(e), t) : Wt;
...
const Bs = {
  ...
  Object.keys(t).forEach(function(u) {
    ...
    if (ke(Kt().flowchart.htmlLabels)) {
      ...
      for (const k of w) {
        ...
        _.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve"), _.setAttribute("dy", "1em"), _.setAttribute("x", "1"), _.textContent = k, v.appendChild(_);
      }
      p = v;
    }
    let y = 0, g = "";
    ...
    O.warn("Adding node", c.id, c.domId), e.setNode(a.db.lookUpDomId(c.id), {
      labelType: "svg",
  ...
  t.forEach(function(s) {
    r++;
    const o = "L-" + s.start + "-" + s.end, l = "LS-" + s.start, u = "LE-" + s.end, c = {};
...
`), s.style === void 0 && (c.style = c.style || "stroke: #333; stroke-width: 1.5px;fill:none"), c.labelStyle = c.labelStyle.replace("color:", "fill:"))), c.id = o, c.class = l + " " + u, c.minlen = s.length || 1, e.setEdge(n.db.lookUpDomId(s.start), n.db.lookUpDomId(s.end), c, r);
  ...
  O.info("Extracting classes"), e.db.clear();
  try {
  ...
  O.info("Drawing flowchart"), r.db.clear();
  ...
  for (let x = p.length - 1; x >= 0; x--)
    d = p[x], r.db.addVertex(d.id, d.title, "group", void 0, d.classes);
  const y = r.db.getVertices();
  O.warn("Get vertices", y);
  ...
  for (v = p.length - 1; v >= 0; v--) {
    ...
    for (let x = 0; x < d.nodes.length; x++)
      O.warn(
        "Setting subgraph",
        d.nodes[x],
        r.db.lookUpDomId(d.nodes[x]),
        r.db.lookUpDomId(d.id)
      ), f.setParent(r.db.lookUpDomId(d.nodes[x]), r.db.lookUpDomId(d.id));
  }
  xn(y, f, e, o, l, r), _n(g, f, r);
  const w = new Ms();
  Bs.addToRender(w), w.arrows().none = function(b, N, m, z) {
  ...
  const k = o.select(`[id="${e}"]`), _ = o.select("#" + e + " g");
  for (w(_, f), _.selectAll("g.node").attr("title", function() {
    return r.db.getTooltip(this.id);
  }), r.db.indexNodes("subGraph" + v), v = 0; v < p.length; v++)
    if (d = p[v], d.title !== "undefined") {
      const x = l.querySelectorAll(
        "#" + e + ' [id="' + r.db.lookUpDomId(d.id) + '"] rect'
      ), b = l.querySelectorAll(
        "#" + e + ' [id="' + r.db.lookUpDomId(d.id) + '"]'
      ), N = x[0].x.baseVal.value, m = x[0].y.baseVal.value, z = x[0].width.baseVal.value, q = et(b[0]).select(".label");
      q.attr("transform", `translate(${N + z / 2}, ${m + 14})`), q.attr("id", e + "Text");
      for (let At = 0; At < d.classes.length; At++)
        b[0].classList.add(d.classes[At]);
    }
  if (!a.htmlLabels) {
    const x = l.querySelectorAll('[id="' + e + '"] .edgeLabel .label');
    for (const b of x) {
  ...
  An(f, k, a.diagramPadding, a.useMaxWidth), Object.keys(y).forEach(function(x) {
    const b = y[x];
    if (b.link) {
      const N = o.select("#" + e + ' [id="' + r.db.lookUpDomId(x) + '"]');
      if (N) {
        ...
        const z = N.insert(function() {
          return m;
        }, ":first-child"), ft = N.select(".label-container");
        ft && z.append(function() {
          return ft.node();
        });
