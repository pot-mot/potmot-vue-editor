...
var O2 = function() {
  var e = function(H1, a, o, T) {
    ...
    parse: function(a) {
      var o = this, T = [0], r = [], X = [null], t = [], r2 = this.table, s = "", l1 = 0, X2 = 0, xe = 2, q2 = 1, Re = t.slice.call(arguments, 1), e1 = Object.create(this.lexer), q1 = { yy: {} };
      ...
      for (var a1, Z1, h1, I2, e2 = {}, D2, K1, Z2, g2; ; ) {
        if (Z1 = T[T.length - 1], this.defaultActions[Z1] ? h1 = this.defaultActions[Z1] : ((a1 === null || typeof a1 > "u") && (a1 = Ie()), h1 = r2[Z1] && r2[Z1][a1]), typeof h1 > "u" || !h1.length || !h1[0]) {
          ...
          g2 = [];
          for (D2 in r2[Z1])
            this.terminals_[D2] && D2 > xe && g2.push("'" + this.terminals_[D2] + "'");
...
let J2 = 0, G2 = w2(), z = {}, J1 = [], t2 = {}, W1 = [], C2 = {}, K2 = {}, F2 = 0, P2 = !0, A1, _2, B2 = [];
const T2 = (e) => We.sanitizeText(e, G2), $2 = function(e, u, i) {
  ...
  H !== void 0 && H.trim().length !== 0 && (z[H] === void 0 && (z[H] = {
    ...
    styles: [],
    classes: []
  }), J2++, u !== void 0 ? (G2 = w2(), u1 = T2(u.text.trim()), z[H].labelType = u.type, u1[0] === '"' && u1[u1.length - 1] === '"' && (u1 = u1.substring(1, u1.length - 1)), z[H].text = u1) : z[H].text === void 0 && (z[H].text = e), i !== void 0 && (z[H].type = i), n != null && n.forEach(function(s1) {
    z[H].styles.push(s1);
  ...
  const B = i.text;
  B !== void 0 && (_.text = T2(B.text.trim()), _.text[0] === '"' && _.text[_.text.length - 1] === '"' && (_.text = _.text.substring(1, _.text.length - 1)), _.labelType = B.type), i !== void 0 && (_.type = i.type, _.stroke = i.stroke, _.length = i.length), J1.push(_);
}, se = function(e, u, i) {
  ...
  t2[e] === void 0 && (t2[e] = { id: e, styles: [], textStyles: [] }), u != null && u.forEach(function(i) {
    if (i.match("color")) {
  ...
  e.split(",").forEach(function(i) {
    let n = i;
    z[n] !== void 0 && z[n].classes.push(u), C2[n] !== void 0 && C2[n].classes.push(u);
  });
}, ze = function(e, u) {
  e.split(",").forEach(function(i) {
    u !== void 0 && (K2[_2 === "gen-1" ? c2(i) : i] = T2(u));
  });
}, He = function(e, u, i) {
  let n = c2(e);
  ...
  c.length === 0 && c.push(e), z[e] !== void 0 && (z[e].haveCallback = !0, B2.push(function() {
    const _ = document.querySelector(`[id="${n}"]`);
  ...
  e.split(",").forEach(function(n) {
    z[n] !== void 0 && (z[n].link = M2.formatUrl(u, G2), z[n].linkTarget = i);
  }), y2(e, "clickable");
}, ce = function(e) {
  return K2[e];
}, oe = function(e, u, i) {
...
const Ee = function(e = "gen-1") {
  z = {}, t2 = {}, J1 = [], B2 = [de], W1 = [], C2 = {}, F2 = 0, K2 = [], P2 = !0, _2 = e, je();
}, be = (e) => {
  _2 = e || "gen-2";
}, ke = function() {
  ...
  if (B = u1, _2 === "gen-1")
    for (let f1 = 0; f1 < B.length; f1++)
      B[f1] = c2(B[f1]);
  n = n || "subGraph" + F2, c = c || "", c = T2(c), F2 = F2 + 1;
  const s1 = {
    id: n,
    nodes: B,
    title: c.trim(),
  ...
  return U2.info("Adding", s1.id, s1.nodes, s1.dir), s1.nodes = me(s1, W1).nodes, W1.push(s1), C2[n] = s1, n;
}, Qe = function(e) {
...
const ge = [], Fe = function(e, u) {
  ...
  let B = qe(".", i);
  return B && (c = "dotted", _ = B), { type: n, stroke: c, length: _ };
}, ye = (e, u) => {
  const i = Ze(e);
  let n;
  if (u) {
    if (n = Xe(u), n.stroke !== i.stroke)
