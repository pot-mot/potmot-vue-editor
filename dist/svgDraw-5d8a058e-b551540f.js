import { F as k, z as v, l as B, G as N } from "./index-b324c4a1.js";
import { l as I } from "./line-b3b77434.js";
let S = 0;
const O = function(i, e, t, a, r) {
  ...
  B.info("Rendering relation " + JSON.stringify(t)), t.relationTitle1 !== void 0 && t.relationTitle1 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type1").attr("x", x).attr("y", m).attr("fill", "black").attr("font-size", "6").text(t.relationTitle1), t.relationTitle2 !== void 0 && t.relationTitle2 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type2").attr("x", f).attr("y", T).attr("fill", "black").attr("font-size", "6").text(t.relationTitle2), S++;
}, P = function(i, e, t, a) {
...
`);
  ...
  if (h > 1 && n > h && n <= i.length) {
    ...
    if (e = r + b + "(" + N(x.trim()) + ")", n < i.length) {
      ...
      t === "" && !m.match(g) ? (t = C(m), a = i.substring(n + 2).trim()) : a = i.substring(n + 1).trim(), a !== "" && (a.charAt(0) === ":" && (a = a.substring(1).trim()), a = " : " + N(a), e += a);
    }
  } else
    e = r + N(i);
  return {
