...
var O2 = function() {
  var e = function(H1, a, o, T) {
    ...
    performAction: function(a, o, T, n, X, t, r2) {
      var s = t.length - 1;
      switch (X) {
        case 5:
    ...
    parse: function(a) {
      var o = this, T = [0], n = [], X = [null], t = [], r2 = this.table, s = "", l1 = 0, X2 = 0, xe = 2, q2 = 1, Re = t.slice.call(arguments, 1), e1 = Object.create(this.lexer), q1 = { yy: {} };
...
` + this.showPosition(), {
  ...
  return x2.prototype = V2, V2.Parser = x2, new x2();
}();
O2.parser = O2;
const et = O2, Ye = "flowchart-";
let J2 = 0, G2 = w2(), z = {}, J1 = [], t2 = {}, W1 = [], _2 = {}, K2 = {}, C2 = 0, P2 = !0, A1, B2, T2 = [];
const y2 = (e) => We.sanitizeText(e, G2), $2 = function(e, u, i) {
  Ke.parseDirective(this, e, u, i);
}, c2 = function(e) {
  ...
  H !== void 0 && H.trim().length !== 0 && (z[H] === void 0 && (z[H] = {
    ...
    styles: [],
    classes: []
  }), J2++, u !== void 0 ? (G2 = w2(), u1 = y2(u.text.trim()), z[H].labelType = u.type, u1[0] === '"' && u1[u1.length - 1] === '"' && (u1 = u1.substring(1, u1.length - 1)), z[H].text = u1) : z[H].text === void 0 && (z[H].text = e), i !== void 0 && (z[H].type = i), r != null && r.forEach(function(s1) {
    z[H].styles.push(s1);
  ...
  const B = i.text;
  B !== void 0 && (_.text = y2(B.text.trim()), _.text[0] === '"' && _.text[_.text.length - 1] === '"' && (_.text = _.text.substring(1, _.text.length - 1)), _.labelType = B.type), i !== void 0 && (_.type = i.type, _.stroke = i.stroke, _.length = i.length), J1.push(_);
}, se = function(e, u, i) {
  U2.info("addLink (abc78)", e, u, i);
  let r, c;
  ...
  e.forEach(function(i) {
    i === "default" ? J1.defaultInterpolate = u : J1[i].interpolate = u;
  });
}, ie = function(e, u) {
  e.forEach(function(i) {
    i === "default" ? J1.defaultStyle = u : (M2.isSubstringInArray("fill", u) === -1 && u.push("fill:none"), J1[i].style = u);
  });
}, re = function(e, u) {
  e.split(",").forEach(function(i) {
    t2[i] === void 0 && (t2[i] = { id: i, styles: [], textStyles: [] }), u != null && u.forEach(function(r) {
      if (r.match("color")) {
        const c = r.replace("fill", "bgFill").replace("color", "fill");
        t2[i].textStyles.push(c);
      }
      t2[i].styles.push(r);
    });
  });
  ...
  e.split(",").forEach(function(i) {
    let r = i;
    z[r] !== void 0 && z[r].classes.push(u), _2[r] !== void 0 && _2[r].classes.push(u);
  });
}, ze = function(e, u) {
  e.split(",").forEach(function(i) {
    u !== void 0 && (K2[B2 === "gen-1" ? c2(i) : i] = y2(u));
  });
}, He = function(e, u, i) {
  let r = c2(e);
  ...
  e.split(",").forEach(function(r) {
    z[r] !== void 0 && (z[r].link = M2.formatUrl(u, G2), z[r].linkTarget = i);
  }), S2(e, "clickable");
}, ce = function(e) {
  return K2[e];
}, oe = function(e, u, i) {
...
const Ee = function(e = "gen-1") {
  z = {}, t2 = {}, J1 = [], T2 = [de], W1 = [], _2 = {}, C2 = 0, K2 = [], P2 = !0, B2 = e, je();
}, be = (e) => {
  B2 = e || "gen-2";
}, ke = function() {
  ...
  if (B = u1, B2 === "gen-1")
    for (let f1 = 0; f1 < B.length; f1++)
      B[f1] = c2(B[f1]);
  r = r || "subGraph" + C2, c = c || "", c = y2(c), C2 = C2 + 1;
  const s1 = {
    id: r,
    nodes: B,
    title: c.trim(),
  ...
  return U2.info("Adding", s1.id, s1.nodes, s1.dir), s1.nodes = me(s1, W1).nodes, W1.push(s1), _2[r] = s1, r;
}, Qe = function(e) {
  for (const [u, i] of W1.entries())
    if (i.id === e)
      return u;
  return -1;
};
