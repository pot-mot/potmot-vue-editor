import { p as R, c as w, d as z, aq as D, h as L, l as y, x as U, B as Q } from "./index-54d0746e.js";
import { c as P } from "./createText-1f5f8f92-42eed1b4.js";
import { p as V } from "./svgDraw-2526cba0-33b3f50d.js";
import { l as et } from "./line-a5be5e47.js";
const st = (r, t, e, l) => {
  t.forEach((a) => {
    bt[a](r, e, l);
  });
...
const Xt = (r, t) => {
  ...
  let p = 0;
  const d = t.classData.annotations && t.classData.annotations[0], x = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", g = b.node().appendChild(T(x, t.labelStyle, !0, !0));
  let k = g.getBBox();
  if (R(w().flowchart.htmlLabels)) {
  ...
  t.classData.members.forEach((E) => {
    ...
    C.width > h && (h = C.width), f += C.height + l, X.push(I);
  }), f += a;
  const Z = [];
  if (t.classData.methods.forEach((E) => {
    ...
    C.width > h && (h = C.width), f += C.height + l, Z.push(I);
  }), f += a, d) {
    let E = (h - k.width) / 2;
    L(g).attr(
      "transform",
