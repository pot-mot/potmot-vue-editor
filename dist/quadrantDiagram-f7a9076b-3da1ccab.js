import { T as Dt, c as _t, U as I, l as ct, s as zt, g as Et, z as It, A as vt, a as Bt, b as Vt, m as wt, B as Rt, h as yt, i as Wt, d as Nt } from "./index-14ad5708.js";
import { l as St } from "./linear-cfac67e6.js";
import "vue";
...
class Qt {
  ...
  getDefaultConfig() {
    var a, c, f, g, x, h, p, s, l, y, B, W, L, C, N, M, X, D;
    return {
      showXAxis: !0,
      showYAxis: !0,
      showTitle: !0,
  ...
  calculateSpace(a, c, f, g) {
    const x = this.config.xAxisLabelPadding * 2 + this.config.xAxisLabelFontSize, h = {
      ...
      top: g ? l : 0
    }, B = this.config.quadrantPadding + s.left, W = this.config.quadrantPadding + h.top + y.top, L = this.config.chartWidth - this.config.quadrantPadding * 2 - s.left - s.right, C = this.config.chartHeight - this.config.quadrantPadding * 2 - h.top - h.bottom - y.top, N = L / 2, M = C / 2;
    return {
      xAxisSpace: h,
      yAxisSpace: s,
      titleSpace: y,
...
` + e);
  ...
  let W;
  B === "sandbox" && (W = yt("#i" + a));
  const C = (B === "sandbox" ? yt(W.nodes()[0].contentDocument.body) : yt("body")).select(`[id="${a}"]`), N = C.append("g").attr("class", "main"), M = ((g = y.quadrantChart) == null ? void 0 : g.chartWidth) || 500, X = ((x = y.quadrantChart) == null ? void 0 : x.chartHeight) || 500;
  Wt(C, X, M, ((h = y.quadrantChart) == null ? void 0 : h.useMaxWidth) || !0), C.attr("viewBox", "0 0 " + M + " " + X), f.db.setHeight(X), f.db.setWidth(M);
