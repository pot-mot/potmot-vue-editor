import { c as A, s as Ae, g as Oe, a as Se, b as Ie, y as Ge, z as Pe, m as Ne, l as G, k as V, A as He, D as pe, h as De, x as Ve, E as ze, F as je } from "./index-54d0746e.js";
import "vue";
var me = function() {
  var r = function(B, l, u, b) {
    for (u = u || {}, b = B.length; b--; u[B[b]] = l)
      ;
    return u;
  }, a = [1, 4], o = [1, 7], h = [1, 5], c = [1, 9], n = [1, 6], f = [2, 6], p = [1, 16], v = [6, 8, 14, 20, 22, 24, 25, 27, 29, 32, 37, 40, 50, 55], y = [8, 14, 20, 22, 24, 25, 27, 29, 32, 37, 40], m = [8, 13, 14, 20, 22, 24, 25, 27, 29, 32, 37, 40], d = [1, 26], _ = [6, 8, 14, 50, 55], s = [8, 14, 55], C = [1, 53], w = [1, 52], H = [8, 14, 30, 33, 35, 38, 55], x = [1, 67], g = [1, 68], k = [1, 69], P = [8, 14, 33, 35, 42, 55], ae = {
    trace: function() {
    },
    yy: {},
...
const $e = function() {
  ...
  T = {}, T[r] = null, Q = {}, Q[r] = { name: r, order: a }, M = r, K = 0, He();
}, tt = function() {
  ...
  Object.keys(a).sort((y, m) => a[y].seq - a[m].seq).forEach((y) => {
    ...
    if (re[m.id] = { x: f + 10, y: d }, o) {
      if (m.type !== N.CHERRY_PICK && (m.customId && m.type === N.MERGE || m.type !== N.MERGE) && h.showCommitLabel) {
        const w = n.append("g"), H = w.insert("rect").attr("class", "commit-label-bkg"), x = w.append("text").attr("x", f).attr("y", d + 25).attr("class", "commit-label").text(m.id);
      ...
      if (m.tag) {
        const w = n.insert("polygon"), H = n.append("circle"), x = n.append("text").attr("y", d - 16).attr("class", "tag-label").text(m.tag);
        let g = x.node().getBBox();
