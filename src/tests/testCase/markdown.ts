...
[toc] {full: true, itemType: "div", listType: "ul"}
...
=== 当然里面可以有别的东西^[比如脚标]
==里面也可以有高亮，不过会失效== :arrow_left:是的，现在左边就是一个高亮
  ~~删除~~ ^1^ ~下标~
**当然加粗也是可以的** :) ===
...
TAB_ITEM2
:::
:::tab-item [x] 通过开头增加[x]可以指定默认选中的选项
TAB_ITEM3
:::
::::
